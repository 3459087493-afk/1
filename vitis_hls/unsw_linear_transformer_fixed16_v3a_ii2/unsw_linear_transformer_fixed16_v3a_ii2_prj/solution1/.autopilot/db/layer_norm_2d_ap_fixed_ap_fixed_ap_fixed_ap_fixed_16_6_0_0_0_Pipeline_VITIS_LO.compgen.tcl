...
set id 73
set name unsw_linear_transformer_mul_mul_16s_16s_32_4_1
...
set id 74
set name unsw_linear_transformer_mul_mul_20s_16s_36_4_1
set corename simcore_mul
set op mul
set stage_num 4
set clk_width 1
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename input_r \
    op interface \
    ports { input_r_address0 { O 7 vector } input_r_ce0 { O 1 bit } input_r_q0 { I 16 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename output_r \
    op interface \
    ports { output_r_address0 { O 7 vector } output_r_ce0 { O 1 bit } output_r_we0 { O 1 bit } output_r_d0 { O 16 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename weight \
    op interface \
    ports { weight_address0 { O 4 vector } weight_ce0 { O 1 bit } weight_q0 { I 12 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename bias \
    op interface \
    ports { bias_address0 { O 4 vector } bias_ce0 { O 1 bit } bias_q0 { I 9 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_conv7_i344 \
    op interface \
    ports { conv7_i344 { I 16 vector } } \
} "
}
