...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler unsw_linear_transformer_unsw_linear_transformer_Pipeline_VITIS_LOOP_105_5_INPUT_PROJECTION_WEIGHT_V_Rbkb BINDTYPE {storage} TYPE {rom} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename input_fp_V \
    op interface \
    ports { input_fp_V_address0 { O 8 vector } input_fp_V_ce0 { O 1 bit } input_fp_V_q0 { I 16 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_ln837 \
    op interface \
    ports { add_ln837 { I 7 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_sub_ln837_1 \
    op interface \
    ports { sub_ln837_1 { I 9 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_sext_ln813_2 \
    op interface \
    ports { sext_ln813_2 { I 14 vector } } \
} "
}
