...
// wrapc file define:
#define AUTOTB_TVIN_input_r "../tv/cdatafile/c.unsw_linear_transformer.autotvin_input_r.dat"
#define AUTOTB_TVOUT_input_r "../tv/cdatafile/c.unsw_linear_transformer.autotvout_input_r.dat"
#define AUTOTB_TVIN_logits "../tv/cdatafile/c.unsw_linear_transformer.autotvin_logits.dat"
#define AUTOTB_TVOUT_logits "../tv/cdatafile/c.unsw_linear_transformer.autotvout_logits.dat"


// tvout file define:
#define AUTOTB_TVOUT_PC_logits "../tv/rtldatafile/rtl.unsw_linear_transformer.autotvout_logits.dat"
...
extern "C"
void unsw_linear_transformer_hw_stub_wrapper(void*, void*);

extern "C"
void apatb_unsw_linear_transformer_hw(void* __xlx_apatb_param_input_r, void* __xlx_apatb_param_logits)
{
#ifdef USE_BINARY_TV_FILE
...
#ifdef POST_CHECK
#ifdef USE_BINARY_TV_FILE
    .reader = new hls::sim::Input(AUTOTB_TVOUT_PC_logits),
#else
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_logits),
#endif
#else
#ifdef USE_BINARY_TV_FILE
    .owriter = new hls::sim::Output(AUTOTB_TVOUT_logits),
#else
    .owriter = new hls::sim::Writer(AUTOTB_TVOUT_logits),
#endif
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_logits),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_logits),
#endif
#endif
  };
  port1.param = { __xlx_apatb_param_logits };
  port1.depth = { 2 };
  port1.offset = {  };
  port1.hasWrite = { true };
  ...
  try {
    ...
    unsw_linear_transformer_hw_stub_wrapper(__xlx_apatb_param_input_r, __xlx_apatb_param_logits);
