set moduleName transformer_for_sample_Pipeline_transpose_value_i_transpose_value_j
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {transformer_for_sample_Pipeline_transpose_value_i_transpose_value_j}
set C_modelType { void 0 }
set C_modelArgList {
	{ value_r float 32 regular {array 64 { 1 3 } 1 1 }  }
	{ value_t float 32 regular {array 64 { 0 3 3 3 3 3 3 3 3 3 3 3 3 3 3 3 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "value_r", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "value_t", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ value_r_address0 sc_out sc_lv 6 signal 0 } 
	{ value_r_ce0 sc_out sc_logic 1 signal 0 } 
	{ value_r_q0 sc_in sc_lv 32 signal 0 } 
	{ value_t_address0 sc_out sc_lv 6 signal 1 } 
	{ value_t_ce0 sc_out sc_logic 1 signal 1 } 
	{ value_t_we0 sc_out sc_logic 1 signal 1 } 
	{ value_t_d0 sc_out sc_lv 32 signal 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "value_t_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "value_t", "role": "we0" }} , 
 	{ "name": "value_t_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "value_t", "role": "d0" }}  ]}
...
set Spec2ImplPortList { 
	value_r { ap_memory {  { value_r_address0 mem_address 1 6 }  { value_r_ce0 mem_ce 1 1 }  { value_r_q0 in_data 0 32 } } }
	value_t { ap_memory {  { value_t_address0 mem_address 1 6 }  { value_t_ce0 mem_ce 1 1 }  { value_t_we0 mem_we 1 1 }  { value_t_d0 mem_din 1 32 } } }
}
