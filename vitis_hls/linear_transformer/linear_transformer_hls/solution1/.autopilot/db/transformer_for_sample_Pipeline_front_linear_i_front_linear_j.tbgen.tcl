set moduleName transformer_for_sample_Pipeline_front_linear_i_front_linear_j
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {transformer_for_sample_Pipeline_front_linear_i_front_linear_j}
set C_modelType { void 0 }
set C_modelArgList {
	{ input_array int 64 regular  }
	{ gmem0 int 32 regular {axi_master 0}  }
	{ front float 32 regular {array 64 { 0 3 3 3 3 3 3 3 3 3 3 3 3 3 3 3 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "input_array", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "front", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ input_array sc_in sc_lv 64 signal 0 } 
	{ front_address0 sc_out sc_lv 6 signal 2 } 
	{ front_ce0 sc_out sc_logic 1 signal 2 } 
	{ front_we0 sc_out sc_logic 1 signal 2 } 
	{ front_d0 sc_out sc_lv 32 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "front_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "front", "role": "we0" }} , 
 	{ "name": "front_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "front", "role": "d0" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.FRONT_LINEAR_WEIGHT_0_U", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.FRONT_LINEAR_WEIGHT_1_U", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.FRONT_LINEAR_BIAS_U", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	front { ap_memory {  { front_address0 mem_address 1 6 }  { front_ce0 mem_ce 1 1 }  { front_we0 mem_we 1 1 }  { front_d0 mem_din 1 32 } } }
}
