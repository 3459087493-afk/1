set moduleName transformer_for_sample_Pipeline_6
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {transformer_for_sample_Pipeline_6}
...
set portList { 
	...
	{ kv_address0 sc_out sc_lv 6 signal 0 } 
	{ kv_ce0 sc_out sc_logic 1 signal 0 } 
	{ kv_we0 sc_out sc_logic 1 signal 0 } 
	{ kv_d0 sc_out sc_lv 32 signal 0 } 
}
set NewPortList {[ 
