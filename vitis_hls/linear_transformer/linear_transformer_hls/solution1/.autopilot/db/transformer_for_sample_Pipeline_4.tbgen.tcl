set moduleName transformer_for_sample_Pipeline_4
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {transformer_for_sample_Pipeline_4}
...
set portList { 
	...
	{ value_r_we0 sc_out sc_logic 1 signal 0 } 
	{ value_r_d0 sc_out sc_lv 32 signal 0 } 
}
set NewPortList {[ 
