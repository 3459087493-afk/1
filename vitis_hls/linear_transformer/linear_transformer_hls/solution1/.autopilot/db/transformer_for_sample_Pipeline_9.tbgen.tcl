set moduleName transformer_for_sample_Pipeline_9
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {transformer_for_sample_Pipeline_9}
set C_modelType { void 0 }
set C_modelArgList {
	{ values_new float 32 regular {array 64 { 0 3 } 0 1 }  }
}
...
set portList { 
	...
	{ values_new_we0 sc_out sc_logic 1 signal 0 } 
	{ values_new_d0 sc_out sc_lv 32 signal 0 } 
}
set NewPortList {[ 
...
set Spec2ImplPortList { 
	values_new { ap_memory {  { values_new_address0 mem_address 1 6 }  { values_new_ce0 mem_ce 1 1 }  { values_new_we0 mem_we 1 1 }  { values_new_d0 mem_din 1 32 } } }
}
