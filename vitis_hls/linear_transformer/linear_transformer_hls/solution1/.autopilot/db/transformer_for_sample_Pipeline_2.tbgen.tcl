set moduleName transformer_for_sample_Pipeline_2
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {transformer_for_sample_Pipeline_2}
...
set portList { 
	...
	{ query_we0 sc_out sc_logic 1 signal 0 } 
	{ query_d0 sc_out sc_lv 32 signal 0 } 
}
set NewPortList {[ 
