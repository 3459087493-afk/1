set moduleName transformer_for_sample_Pipeline_3
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {transformer_for_sample_Pipeline_3}
...
set portList { 
	...
	{ key_we0 sc_out sc_logic 1 signal 0 } 
	{ key_d0 sc_out sc_lv 32 signal 0 } 
}
set NewPortList {[ 
