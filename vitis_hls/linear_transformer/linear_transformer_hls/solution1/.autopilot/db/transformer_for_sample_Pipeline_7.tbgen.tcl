set moduleName transformer_for_sample_Pipeline_7
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {transformer_for_sample_Pipeline_7}
...
set portList { 
	...
	{ sum_k_address0 sc_out sc_lv 3 signal 0 } 
	{ sum_k_ce0 sc_out sc_logic 1 signal 0 } 
	{ sum_k_we0 sc_out sc_logic 1 signal 0 } 
	{ sum_k_d0 sc_out sc_lv 32 signal 0 } 
}
set NewPortList {[ 
