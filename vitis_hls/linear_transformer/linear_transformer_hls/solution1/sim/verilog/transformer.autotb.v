...
`define AUTOTB_DUT      transformer
`define AUTOTB_DUT_INST AESL_inst_transformer
`define AUTOTB_TOP      apatb_transformer_top
`define AUTOTB_LAT_RESULT_FILE "transformer.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "transformer.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_transformer_top
`define AUTOTB_MAX_ALLOW_LATENCY  15000000
`define AUTOTB_CLOCK_PERIOD_DIV2 5.00

`define AESL_DEPTH_gmem0 1
`define AESL_DEPTH_gmem1 1
`define AESL_DEPTH_input_array 1
...
`define AUTOTB_TVIN_gmem0_out_wrapc  "../tv/rtldatafile/rtl.transformer.autotvin_gmem0.dat"
`define AUTOTB_TVIN_input_array_out_wrapc  "../tv/rtldatafile/rtl.transformer.autotvin_input_array.dat"
`define AUTOTB_TVIN_val_r_out_wrapc  "../tv/rtldatafile/rtl.transformer.autotvin_val_r.dat"
`define AUTOTB_TVOUT_gmem1  "../tv/cdatafile/c.transformer.autotvout_gmem1.dat"
`define AUTOTB_TVOUT_gmem1_out_wrapc  "../tv/rtldatafile/rtl.transformer.autotvout_gmem1.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 1568;
parameter LENGTH_gmem0 = 16;
parameter LENGTH_gmem1 = 1;
parameter LENGTH_input_array = 1;
...
reg end_input_array;
reg [31:0] size_input_array;
reg [31:0] size_input_array_backup;
reg end_val_r;
reg [31:0] size_val_r;
