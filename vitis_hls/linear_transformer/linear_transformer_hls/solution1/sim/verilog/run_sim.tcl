...
if {[file isfile transformer.autotvin.dat]} {
	file delete -force transformer.autotvin.dat
}

if {[file isfile transformer.autotvout.dat]} {
	file delete -force transformer.autotvout.dat
}
