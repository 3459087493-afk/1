...
// wrapc file define:
#define AUTOTB_TVIN_input_array "../tv/cdatafile/c.transformer.autotvin_input_array.dat"
#define AUTOTB_TVOUT_input_array "../tv/cdatafile/c.transformer.autotvout_input_array.dat"
...
#define AUTOTB_TVIN_gmem0 "../tv/cdatafile/c.transformer.autotvin_gmem0.dat"
#define AUTOTB_TVOUT_gmem0 "../tv/cdatafile/c.transformer.autotvout_gmem0.dat"
#define AUTOTB_TVIN_gmem1 "../tv/cdatafile/c.transformer.autotvin_gmem1.dat"
#define AUTOTB_TVOUT_gmem1 "../tv/cdatafile/c.transformer.autotvout_gmem1.dat"


// tvout file define:
#define AUTOTB_TVOUT_PC_gmem0 "../tv/rtldatafile/rtl.transformer.autotvout_gmem0.dat"
#define AUTOTB_TVOUT_PC_gmem1 "../tv/rtldatafile/rtl.transformer.autotvout_gmem1.dat"
...
extern "C"
void transformer_hw_stub_wrapper(void*, void*);

extern "C"
void apatb_transformer_hw(void* __xlx_apatb_param_input_array, void* __xlx_apatb_param_val_r)
{
  hls::sim::Byte<4> __xlx_offset_byte_param_input_array;
...
#else
    .owriter = nullptr,
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_input_array),
#endif
  };
  port0.param = &__xlx_offset_byte_param_input_array;

  hls::sim::Byte<4> __xlx_offset_byte_param_val_r;
  ...
  port1.param = &__xlx_offset_byte_param_val_r;
  ...
  port2.param = { __xlx_apatb_param_input_array };
  port2.depth = { 16 };
  port2.offset = {  };
  ...
  port3.param = { __xlx_apatb_param_val_r };
  port3.depth = { 1 };
  port3.offset = {  };
  port3.hasWrite = { true };
  ...
  try {
    ...
    transformer_hw_stub_wrapper(__xlx_apatb_param_input_array, __xlx_apatb_param_val_r);
