...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "transformer.autotvin.dat"
	set constFileTvOut       "transformer.autotvout.dat"
	set constFileHdlTvIn     "transformer.autohdltvin.dat"
	set constFileHdlTvOut    "transformer.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
