set moduleName unsw_linear_transformer_Pipeline_VITIS_LOOP_172_15_VITIS_LOOP_173_16_VITIS_LOOP_s
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {unsw_linear_transformer_Pipeline_VITIS_LOOP_172_15_VITIS_LOOP_173_16_VITIS_LOOP_}
set C_modelType { void 0 }
set C_modelArgList {
	{ key_value_V int 28 regular {array 256 { 0 3 } 0 1 }  }
	{ key_V int 16 regular {array 128 { 1 3 } 1 1 }  }
	{ value_V int 16 regular {array 128 { 1 3 } 1 1 }  }
}
...
set portList { 
	...
	{ key_value_V_we0 sc_out sc_logic 1 signal 0 } 
	{ key_value_V_d0 sc_out sc_lv 28 signal 0 } 
	{ key_V_address0 sc_out sc_lv 7 signal 1 } 
	{ key_V_ce0 sc_out sc_logic 1 signal 1 } 
	{ key_V_q0 sc_in sc_lv 16 signal 1 } 
	{ value_V_address0 sc_out sc_lv 7 signal 2 } 
	{ value_V_ce0 sc_out sc_logic 1 signal 2 } 
	{ value_V_q0 sc_in sc_lv 16 signal 2 } 
}
set NewPortList {[ 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_22s_22s_44_1_1_U34", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.flow_control_loop_pipe_sequential_init_U", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	unsw_linear_transformer_Pipeline_VITIS_LOOP_172_15_VITIS_LOOP_173_16_VITIS_LOOP_s {
		key_value_V {Type O LastRead -1 FirstWrite 4}
		key_V {Type I LastRead 1 FirstWrite -1}
		value_V {Type I LastRead 1 FirstWrite -1}}}
...
set Spec2ImplPortList { 
	...
	key_V { ap_memory {  { key_V_address0 mem_address 1 7 }  { key_V_ce0 mem_ce 1 1 }  { key_V_q0 in_data 0 16 } } }
	value_V { ap_memory {  { value_V_address0 mem_address 1 7 }  { value_V_ce0 mem_ce 1 1 }  { value_V_q0 in_data 0 16 } } }
}
