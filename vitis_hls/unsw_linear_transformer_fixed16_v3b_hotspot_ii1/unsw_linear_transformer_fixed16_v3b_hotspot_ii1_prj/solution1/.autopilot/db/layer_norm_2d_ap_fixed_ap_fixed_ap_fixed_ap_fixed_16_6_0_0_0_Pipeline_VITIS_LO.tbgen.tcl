...
set Spec2ImplPortList { 
	...
	weight { ap_memory {  { weight_address0 mem_address 1 4 }  { weight_ce0 mem_ce 1 1 }  { weight_q0 in_data 0 12 } } }
	bias { ap_memory {  { bias_address0 mem_address 1 4 }  { bias_ce0 mem_ce 1 1 }  { bias_q0 in_data 0 9 } } }
}
