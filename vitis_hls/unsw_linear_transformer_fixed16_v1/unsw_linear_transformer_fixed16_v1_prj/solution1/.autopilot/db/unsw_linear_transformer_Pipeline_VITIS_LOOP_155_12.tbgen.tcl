set moduleName unsw_linear_transformer_Pipeline_VITIS_LOOP_155_12
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {unsw_linear_transformer_Pipeline_VITIS_LOOP_155_12}
set C_modelType { void 0 }
set C_modelArgList {
	{ key_V int 16 regular {array 128 { 1 1 1 1 1 1 1 1 3 3 3 3 3 3 3 3 3 } 1 1 }  }
	{ key_sum_arr_V int 16 regular {array 16 { 0 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "key_V", "interface" : "memory", "bitwidth" : 16, "direction" : "READONLY"} , 
 	{ "Name" : "key_sum_arr_V", "interface" : "memory", "bitwidth" : 16, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ key_sum_arr_V_address0 sc_out sc_lv 4 signal 1 } 
	{ key_sum_arr_V_ce0 sc_out sc_logic 1 signal 1 } 
	{ key_sum_arr_V_we0 sc_out sc_logic 1 signal 1 } 
	{ key_sum_arr_V_d0 sc_out sc_lv 16 signal 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "key_sum_arr_V_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "key_sum_arr_V", "role": "we0" }} , 
 	{ "name": "key_sum_arr_V_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "key_sum_arr_V", "role": "d0" }}  ]}
...
set Spec2ImplPortList { 
	key_V { ap_memory {  { key_V_address0 mem_address 1 7 }  { key_V_ce0 mem_ce 1 1 }  { key_V_q0 mem_dout 0 16 }  { key_V_address1 MemPortADDR2 1 7 }  { key_V_ce1 MemPortCE2 1 1 }  { key_V_q1 MemPortDOUT2 0 16 }  { key_V_address2 MemPortADDR2 1 7 }  { key_V_ce2 MemPortCE2 1 1 }  { key_V_q2 MemPortDOUT2 0 16 }  { key_V_address3 MemPortADDR2 1 7 }  { key_V_ce3 MemPortCE2 1 1 }  { key_V_q3 MemPortDOUT2 0 16 }  { key_V_address4 MemPortADDR2 1 7 }  { key_V_ce4 MemPortCE2 1 1 }  { key_V_q4 MemPortDOUT2 0 16 }  { key_V_address5 MemPortADDR2 1 7 }  { key_V_ce5 MemPortCE2 1 1 }  { key_V_q5 MemPortDOUT2 0 16 }  { key_V_address6 MemPortADDR2 1 7 }  { key_V_ce6 MemPortCE2 1 1 }  { key_V_q6 in_data 0 16 }  { key_V_address7 MemPortADDR2 1 7 }  { key_V_ce7 MemPortCE2 1 1 }  { key_V_q7 in_data 0 16 } } }
	key_sum_arr_V { ap_memory {  { key_sum_arr_V_address0 mem_address 1 4 }  { key_sum_arr_V_ce0 mem_ce 1 1 }  { key_sum_arr_V_we0 mem_we 1 1 }  { key_sum_arr_V_d0 mem_din 1 16 } } }
}
