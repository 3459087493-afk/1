...
set id 297
set name unsw_linear_transformer_mul_mul_20s_14ns_34_4_1
set corename simcore_mul
set op mul
set stage_num 4
set clk_width 1
...
set ce_signed 0
set out_width 34
set arg_lists {i0 {20 1 +} i1 {14 0 +} p {34 1 +} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $name BINDTYPE {op} TYPE {all} IMPL {dsp48} LATENCY 3 ALLOW_PRAGMA 1
}
...
set id 308
set name unsw_linear_transformer_mul_mul_20s_13s_33_4_1
set corename simcore_mul
set op mul
set stage_num 4
set clk_width 1
...
set ce_signed 0
set out_width 33
set arg_lists {i0 {20 1 +} i1 {13 1 +} p {33 1 +} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $name BINDTYPE {op} TYPE {all} IMPL {dsp48} LATENCY 3 ALLOW_PRAGMA 1
}
