...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler unsw_linear_transformer_unsw_linear_transformer_Pipeline_VITIS_LOOP_261_32_LAYERS_0_FEEDFORWARD_3_WEIhbi BINDTYPE {storage} TYPE {rom} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { feedforward_hidden_V_address0 { O 8 vector } feedforward_hidden_V_ce0 { O 1 bit } feedforward_hidden_V_q0 { I 15 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_ln837_14 \
    op interface \
    ports { add_ln837_14 { I 7 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { zext_ln837_17 { I 9 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_zext_ln837_16 \
    op interface \
    ports { zext_ln837_16 { I 8 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_sext_ln813_7 \
    op interface \
    ports { sext_ln813_7 { I 20 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_sext_ln1347_28 \
    op interface \
    ports { sext_ln1347_28 { I 20 vector } } \
} "
}
