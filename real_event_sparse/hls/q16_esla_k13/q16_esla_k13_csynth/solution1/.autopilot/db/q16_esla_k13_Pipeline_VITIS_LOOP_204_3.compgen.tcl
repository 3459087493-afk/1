...
set id 1
set name q16_esla_k13_mul_mul_9s_16s_25_4_1
...
set ce_signed 0
set out_width 25
set arg_lists {i0 {9 1 +} i1 {16 1 +} p {25 1 +} acc {0} }
set TrueReset 0
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler q16_esla_k13_q16_esla_k13_Pipeline_VITIS_LOOP_204_3_input_projection_weight_V_ROM_AUTO_1R BINDTYPE {storage} TYPE {rom} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename x_full_V \
    op interface \
    ports { x_full_V_address0 { O 8 vector } x_full_V_ce0 { O 1 bit } x_full_V_we0 { O 1 bit } x_full_V_d0 { O 16 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_sext_ln203 \
    op interface \
    ports { sext_ln203 { I 13 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_ln209 \
    op interface \
    ports { add_ln209 { I 8 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_sext_ln813 \
    op interface \
    ports { sext_ln813 { I 10 vector } } \
} "
}
