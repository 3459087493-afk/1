set moduleName q16_esla_k13_Pipeline_VITIS_LOOP_43_1
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {q16_esla_k13_Pipeline_VITIS_LOOP_43_1}
set C_modelType { void 0 }
set C_modelArgList {
	{ token_score_V int 21 regular {array 16 { 1 3 } 1 1 }  }
	{ sorted_score_V int 21 regular {array 16 { 0 3 } 0 1 }  }
	{ sorted_index int 4 regular {array 16 { 0 3 3 3 3 3 3 3 3 3 3 3 3 3 3 3 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "token_score_V", "interface" : "memory", "bitwidth" : 21, "direction" : "READONLY"} , 
 	{ "Name" : "sorted_score_V", "interface" : "memory", "bitwidth" : 21, "direction" : "WRITEONLY"} , 
 	{ "Name" : "sorted_index", "interface" : "memory", "bitwidth" : 4, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ token_score_V_address0 sc_out sc_lv 4 signal 0 } 
	{ token_score_V_ce0 sc_out sc_logic 1 signal 0 } 
	{ token_score_V_q0 sc_in sc_lv 21 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "token_score_V_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "token_score_V", "role": "address0" }} , 
 	{ "name": "token_score_V_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "token_score_V", "role": "ce0" }} , 
 	{ "name": "token_score_V_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":21, "type": "signal", "bundle":{"name": "token_score_V", "role": "q0" }} , 
...
set Spec2ImplPortList { 
	token_score_V { ap_memory {  { token_score_V_address0 mem_address 1 4 }  { token_score_V_ce0 mem_ce 1 1 }  { token_score_V_q0 in_data 0 21 } } }
	sorted_score_V { ap_memory {  { sorted_score_V_address0 mem_address 1 4 }  { sorted_score_V_ce0 mem_ce 1 1 }  { sorted_score_V_we0 mem_we 1 1 }  { sorted_score_V_d0 mem_din 1 21 } } }
	sorted_index { ap_memory {  { sorted_index_address0 mem_address 1 4 }  { sorted_index_ce0 mem_ce 1 1 }  { sorted_index_we0 mem_we 1 1 }  { sorted_index_d0 mem_din 1 4 } } }
}
