set moduleName attention_active13_Pipeline_VITIS_LOOP_144_14
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {attention_active13_Pipeline_VITIS_LOOP_144_14}
set C_modelType { void 0 }
set C_modelArgList {
	{ sext_ln143 int 11 regular  }
	{ x_active int 16 regular {array 208 { 0 1 } 1 1 }  }
	{ add_ln813_20 int 8 regular  }
	{ tmp_141 int 8 regular  }
	{ attended_V int 16 regular {array 16 { 1 3 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "sext_ln143", "interface" : "wire", "bitwidth" : 11, "direction" : "READONLY"} , 
 	{ "Name" : "x_active", "interface" : "memory", "bitwidth" : 16, "direction" : "READWRITE"} , 
 	{ "Name" : "add_ln813_20", "interface" : "wire", "bitwidth" : 8, "direction" : "READONLY"} , 
 	{ "Name" : "tmp_141", "interface" : "wire", "bitwidth" : 8, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ sext_ln143 sc_in sc_lv 11 signal 0 } 
	{ x_active_address0 sc_out sc_lv 8 signal 1 } 
	{ x_active_ce0 sc_out sc_logic 1 signal 1 } 
	{ x_active_we0 sc_out sc_logic 1 signal 1 } 
	{ x_active_d0 sc_out sc_lv 16 signal 1 } 
	{ x_active_address1 sc_out sc_lv 8 signal 1 } 
	{ x_active_ce1 sc_out sc_logic 1 signal 1 } 
	{ x_active_q1 sc_in sc_lv 16 signal 1 } 
	{ add_ln813_20 sc_in sc_lv 8 signal 2 } 
	{ tmp_141 sc_in sc_lv 8 signal 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln143", "direction": "in", "datatype": "sc_lv", "bitwidth":11, "type": "signal", "bundle":{"name": "sext_ln143", "role": "default" }} , 
 	...
 	{ "name": "add_ln813_20", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "add_ln813_20", "role": "default" }} , 
 	{ "name": "tmp_141", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "tmp_141", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_mul_10s_16s_26_4_1_U73", "Parent" : "0"},
...
set Spec2ImplPortList { 
	sext_ln143 { ap_none {  { sext_ln143 in_data 0 11 } } }
	x_active { ap_memory {  { x_active_address0 mem_address 1 8 }  { x_active_ce0 mem_ce 1 1 }  { x_active_we0 mem_we 1 1 }  { x_active_d0 mem_din 1 16 }  { x_active_address1 MemPortADDR2 1 8 }  { x_active_ce1 MemPortCE2 1 1 }  { x_active_q1 in_data 0 16 } } }
	add_ln813_20 { ap_none {  { add_ln813_20 in_data 0 8 } } }
	tmp_141 { ap_none {  { tmp_141 in_data 0 8 } } }
