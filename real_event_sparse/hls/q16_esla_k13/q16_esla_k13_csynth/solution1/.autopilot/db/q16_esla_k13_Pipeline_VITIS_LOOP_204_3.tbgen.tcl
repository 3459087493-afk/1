set moduleName q16_esla_k13_Pipeline_VITIS_LOOP_204_3
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {q16_esla_k13_Pipeline_VITIS_LOOP_204_3}
set C_modelType { void 0 }
set C_modelArgList {
	{ sext_ln203 int 13 regular  }
	{ gmem0 int 16 regular {axi_master 0}  }
	{ x_full_V int 16 regular {array 256 { 0 3 3 3 3 3 3 3 3 3 3 3 3 3 3 3 3 } 0 1 }  }
	{ add_ln209 int 8 regular  }
	{ sext_ln201 int 63 regular  }
	{ tmp_6 int 10 regular  }
	{ sext_ln813 int 10 regular  }
}
set C_modelArgMapList {[ 
	{ "Name" : "sext_ln203", "interface" : "wire", "bitwidth" : 13, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "x_full_V", "interface" : "memory", "bitwidth" : 16, "direction" : "WRITEONLY"} , 
 	{ "Name" : "add_ln209", "interface" : "wire", "bitwidth" : 8, "direction" : "READONLY"} , 
 	{ "Name" : "sext_ln201", "interface" : "wire", "bitwidth" : 63, "direction" : "READONLY"} , 
 	{ "Name" : "tmp_6", "interface" : "wire", "bitwidth" : 10, "direction" : "READONLY"} , 
 	{ "Name" : "sext_ln813", "interface" : "wire", "bitwidth" : 10, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ m_axi_gmem0_WDATA sc_out sc_lv 16 signal 1 } 
	{ m_axi_gmem0_WSTRB sc_out sc_lv 2 signal 1 } 
	...
	{ m_axi_gmem0_RDATA sc_in sc_lv 16 signal 1 } 
	{ m_axi_gmem0_RLAST sc_in sc_logic 1 signal 1 } 
	{ m_axi_gmem0_RID sc_in sc_lv 1 signal 1 } 
	{ m_axi_gmem0_RFIFONUM sc_in sc_lv 10 signal 1 } 
	...
	{ sext_ln203 sc_in sc_lv 13 signal 0 } 
	{ x_full_V_address0 sc_out sc_lv 8 signal 2 } 
	{ x_full_V_ce0 sc_out sc_logic 1 signal 2 } 
	{ x_full_V_we0 sc_out sc_logic 1 signal 2 } 
	{ x_full_V_d0 sc_out sc_lv 16 signal 2 } 
	{ add_ln209 sc_in sc_lv 8 signal 3 } 
	{ sext_ln201 sc_in sc_lv 63 signal 4 } 
	{ tmp_6 sc_in sc_lv 10 signal 5 } 
	{ sext_ln813 sc_in sc_lv 10 signal 6 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln203", "direction": "in", "datatype": "sc_lv", "bitwidth":13, "type": "signal", "bundle":{"name": "sext_ln203", "role": "default" }} , 
 	...
 	{ "name": "x_full_V_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "x_full_V", "role": "we0" }} , 
 	{ "name": "x_full_V_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "x_full_V", "role": "d0" }} , 
 	{ "name": "add_ln209", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "add_ln209", "role": "default" }} , 
 	{ "name": "sext_ln201", "direction": "in", "datatype": "sc_lv", "bitwidth":63, "type": "signal", "bundle":{"name": "sext_ln201", "role": "default" }} , 
 	{ "name": "tmp_6", "direction": "in", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "tmp_6", "role": "default" }} , 
 	{ "name": "sext_ln813", "direction": "in", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "sext_ln813", "role": "default" }}  ]}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_mul_9s_16s_25_4_1_U1", "Parent" : "0"},
...
set Spec2ImplPortList { 
	sext_ln203 { ap_none {  { sext_ln203 in_data 0 13 } } }
	...
	x_full_V { ap_memory {  { x_full_V_address0 mem_address 1 8 }  { x_full_V_ce0 mem_ce 1 1 }  { x_full_V_we0 mem_we 1 1 }  { x_full_V_d0 mem_din 1 16 } } }
	add_ln209 { ap_none {  { add_ln209 in_data 0 8 } } }
	sext_ln201 { ap_none {  { sext_ln201 in_data 0 63 } } }
	tmp_6 { ap_none {  { tmp_6 in_data 0 10 } } }
	sext_ln813 { ap_none {  { sext_ln813 in_data 0 10 } } }
}
