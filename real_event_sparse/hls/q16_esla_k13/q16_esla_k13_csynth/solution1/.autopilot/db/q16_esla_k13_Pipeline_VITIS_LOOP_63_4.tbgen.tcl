set moduleName q16_esla_k13_Pipeline_VITIS_LOOP_63_4
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {q16_esla_k13_Pipeline_VITIS_LOOP_63_4}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem2 int 32 regular {axi_master 1}  }
	{ sext_ln63 int 62 regular  }
	{ sorted_index int 4 regular {array 16 { 1 3 3 3 3 3 3 3 3 3 3 3 3 3 3 3 3 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "gmem2", "interface" : "axi_master", "bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "active_token_indices","offset": { "type": "dynamic","port_name": "active_token_indices","bundle": "control"},"direction": "READWRITE"}]}]} , 
 	{ "Name" : "sext_ln63", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} , 
 	{ "Name" : "sorted_index", "interface" : "memory", "bitwidth" : 4, "direction" : "READONLY"} ]}
...
set Spec2ImplPortList { 
	...
	sorted_index { ap_memory {  { sorted_index_address0 mem_address 1 4 }  { sorted_index_ce0 mem_ce 1 1 }  { sorted_index_q0 mem_dout 0 4 } } }
}
