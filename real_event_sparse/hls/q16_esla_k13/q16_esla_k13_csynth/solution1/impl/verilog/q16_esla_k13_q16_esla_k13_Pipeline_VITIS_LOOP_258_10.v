...
module q16_esla_k13_q16_esla_k13_Pipeline_VITIS_LOOP_258_10 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [0:0] icmp_ln258_reg_201;
wire   [3:0] add_ln258_fu_179_p2;
reg   [3:0] add_ln258_reg_205;
reg    ap_enable_reg_pp0_iter0_reg;
wire    grp_layer_norm_q16_1_fu_94_ap_start;
wire    grp_layer_norm_q16_1_fu_94_ap_done;
wire    grp_layer_norm_q16_1_fu_94_ap_idle;
wire    grp_layer_norm_q16_1_fu_94_ap_ready;
wire   [7:0] grp_layer_norm_q16_1_fu_94_x_address0;
wire    grp_layer_norm_q16_1_fu_94_x_ce0;
wire    grp_layer_norm_q16_1_fu_94_x_we0;
wire   [15:0] grp_layer_norm_q16_1_fu_94_x_d0;
wire   [7:0] grp_layer_norm_q16_1_fu_94_x_address1;
wire    grp_layer_norm_q16_1_fu_94_x_ce1;
wire    grp_layer_norm_q16_1_fu_94_x_we1;
wire   [15:0] grp_layer_norm_q16_1_fu_94_x_d1;
reg    grp_layer_norm_q16_1_fu_94_ap_start_reg;
...
#0 grp_layer_norm_q16_1_fu_94_ap_start_reg = 1'b0;
#0 ap_done_reg = 1'b0;
end

q16_esla_k13_layer_norm_q16_1 grp_layer_norm_q16_1_fu_94(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        grp_layer_norm_q16_1_fu_94_ap_start_reg <= 1'b0;
    end else begin
        if (((1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln258_fu_173_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            grp_layer_norm_q16_1_fu_94_ap_start_reg <= 1'b1;
        end else if ((grp_layer_norm_q16_1_fu_94_ap_ready == 1'b1)) begin
            grp_layer_norm_q16_1_fu_94_ap_start_reg <= 1'b0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        a_fu_90 <= 4'd0;
    end else if (((1'b1 == ap_CS_fsm_pp0_stage1) & (icmp_ln258_reg_201 == 1'd0) & (1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln258_fu_173_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
assign add_ln258_fu_179_p2 = (ap_sig_allocacmp_a_2 + 4'd1);
...
assign grp_layer_norm_q16_1_fu_94_ap_start = grp_layer_norm_q16_1_fu_94_ap_start_reg;

assign icmp_ln258_fu_173_p2 = ((ap_sig_allocacmp_a_2 == 4'd13) ? 1'b1 : 1'b0);

assign x_active_V_address0 = grp_layer_norm_q16_1_fu_94_x_address0;

assign x_active_V_address1 = grp_layer_norm_q16_1_fu_94_x_address1;

assign x_active_V_ce0 = grp_layer_norm_q16_1_fu_94_x_ce0;

assign x_active_V_ce1 = grp_layer_norm_q16_1_fu_94_x_ce1;

assign x_active_V_d0 = grp_layer_norm_q16_1_fu_94_x_d0;

assign x_active_V_d1 = grp_layer_norm_q16_1_fu_94_x_d1;

assign x_active_V_we0 = grp_layer_norm_q16_1_fu_94_x_we0;

assign x_active_V_we1 = grp_layer_norm_q16_1_fu_94_x_we1;

endmodule //q16_esla_k13_q16_esla_k13_Pipeline_VITIS_LOOP_258_10
