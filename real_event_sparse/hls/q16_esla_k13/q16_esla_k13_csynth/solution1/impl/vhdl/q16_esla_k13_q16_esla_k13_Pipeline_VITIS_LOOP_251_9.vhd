...
entity q16_esla_k13_q16_esla_k13_Pipeline_VITIS_LOOP_251_9 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of q16_esla_k13_q16_esla_k13_Pipeline_VITIS_LOOP_251_9 is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln251_fu_171_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal a_3_reg_194 : STD_LOGIC_VECTOR (3 downto 0);
    signal ap_block_pp0_stage0_11001 : BOOLEAN;
    signal icmp_ln251_reg_199 : STD_LOGIC_VECTOR (0 downto 0);
    signal add_ln251_fu_177_p2 : STD_LOGIC_VECTOR (3 downto 0);
    signal add_ln251_reg_203 : STD_LOGIC_VECTOR (3 downto 0);
    signal ap_enable_reg_pp0_iter0_reg : STD_LOGIC := '0';
    signal grp_layer_norm_q16_1_fu_92_ap_start : STD_LOGIC;
    signal grp_layer_norm_q16_1_fu_92_ap_done : STD_LOGIC;
    signal grp_layer_norm_q16_1_fu_92_ap_idle : STD_LOGIC;
    signal grp_layer_norm_q16_1_fu_92_ap_ready : STD_LOGIC;
    signal grp_layer_norm_q16_1_fu_92_x_address0 : STD_LOGIC_VECTOR (7 downto 0);
    signal grp_layer_norm_q16_1_fu_92_x_ce0 : STD_LOGIC;
    signal grp_layer_norm_q16_1_fu_92_x_we0 : STD_LOGIC;
    signal grp_layer_norm_q16_1_fu_92_x_d0 : STD_LOGIC_VECTOR (15 downto 0);
    signal grp_layer_norm_q16_1_fu_92_x_address1 : STD_LOGIC_VECTOR (7 downto 0);
    signal grp_layer_norm_q16_1_fu_92_x_ce1 : STD_LOGIC;
    signal grp_layer_norm_q16_1_fu_92_x_we1 : STD_LOGIC;
    signal grp_layer_norm_q16_1_fu_92_x_d1 : STD_LOGIC_VECTOR (15 downto 0);
    signal grp_layer_norm_q16_1_fu_92_ap_start_reg : STD_LOGIC := '0';
    ...
    signal a_fu_88 : STD_LOGIC_VECTOR (3 downto 0);
    signal ap_block_state2_pp0_stage1_iter0 : BOOLEAN;
    signal ap_block_pp0_stage1_11001 : BOOLEAN;
    signal ap_loop_init : STD_LOGIC;
    signal ap_sig_allocacmp_a_3 : STD_LOGIC_VECTOR (3 downto 0);
    ...
    component q16_esla_k13_layer_norm_q16_1 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
...
begin
    grp_layer_norm_q16_1_fu_92 : component q16_esla_k13_layer_norm_q16_1
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ...
        x_q1 => x_active_V_q1,
        x_offset => a_3_reg_194,
        p_read => ap_const_lv11_427,
        p_read1 => ap_const_lv11_423,
        p_read2 => ap_const_lv11_405,
        p_read3 => ap_const_lv11_496,
        p_read4 => ap_const_lv11_3F5,
        p_read5 => ap_const_lv11_428,
        p_read6 => ap_const_lv8_AA,
        p_read7 => ap_const_lv8_FA,
        p_read8 => ap_const_lv7_55,
        p_read9 => ap_const_lv11_483,
        p_read10 => ap_const_lv11_40B,
        p_read11 => ap_const_lv11_40B,
        p_read12 => ap_const_lv7_5F,
        p_read13 => ap_const_lv11_417,
        p_read14 => ap_const_lv11_3EE,
        p_read15 => ap_const_lv11_481,
        p_read16 => ap_const_lv6_37,
        p_read17 => ap_const_lv6_27,
        p_read18 => ap_const_lv7_2C,
        p_read19 => ap_const_lv7_28,
        p_read20 => ap_const_lv5_17,
        p_read21 => ap_const_lv6_0,
        p_read22 => ap_const_lv6_14,
        p_read23 => ap_const_lv5_1F,
        p_read24 => ap_const_lv8_B5,
        p_read25 => ap_const_lv6_23,
        p_read26 => ap_const_lv7_54,
        p_read27 => ap_const_lv5_1C,
        p_read28 => ap_const_lv6_23,
    ...
    grp_layer_norm_q16_1_fu_92_ap_start_reg_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                grp_layer_norm_q16_1_fu_92_ap_start_reg <= ap_const_logic_0;
            else
                if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln251_fu_171_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) then 
                    grp_layer_norm_q16_1_fu_92_ap_start_reg <= ap_const_logic_1;
                elsif ((grp_layer_norm_q16_1_fu_92_ap_ready = ap_const_logic_1)) then 
                    grp_layer_norm_q16_1_fu_92_ap_start_reg <= ap_const_logic_0;
                end if; 
            end if;
        end if;
    ...
    a_fu_88_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_loop_init = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then 
                a_fu_88 <= ap_const_lv4_0;
            elsif (((ap_const_logic_1 = ap_CS_fsm_pp0_stage1) and (icmp_ln251_reg_199 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage1_11001) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) then 
                a_fu_88 <= add_ln251_reg_203;
            end if; 
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                a_3_reg_194 <= ap_sig_allocacmp_a_3;
                add_ln251_reg_203 <= add_ln251_fu_177_p2;
                icmp_ln251_reg_199 <= icmp_ln251_fu_171_p2;
            end if;
        end if;
    end process;
    ...
    add_ln251_fu_177_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_a_3) + unsigned(ap_const_lv4_1));
    ...
    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone, icmp_ln251_fu_171_p2)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln251_fu_171_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) then 
    ...
    ap_sig_allocacmp_a_3_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, a_fu_88, ap_loop_init)
    begin
        if (((ap_loop_init = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0))) then 
            ap_sig_allocacmp_a_3 <= ap_const_lv4_0;
        else 
            ap_sig_allocacmp_a_3 <= a_fu_88;
        end if; 
    end process;

    grp_layer_norm_q16_1_fu_92_ap_start <= grp_layer_norm_q16_1_fu_92_ap_start_reg;
    icmp_ln251_fu_171_p2 <= "1" when (ap_sig_allocacmp_a_3 = ap_const_lv4_D) else "0";
    x_active_V_address0 <= grp_layer_norm_q16_1_fu_92_x_address0;
    x_active_V_address1 <= grp_layer_norm_q16_1_fu_92_x_address1;
    x_active_V_ce0 <= grp_layer_norm_q16_1_fu_92_x_ce0;
    x_active_V_ce1 <= grp_layer_norm_q16_1_fu_92_x_ce1;
    x_active_V_d0 <= grp_layer_norm_q16_1_fu_92_x_d0;
    x_active_V_d1 <= grp_layer_norm_q16_1_fu_92_x_d1;
    x_active_V_we0 <= grp_layer_norm_q16_1_fu_92_x_we0;
    x_active_V_we1 <= grp_layer_norm_q16_1_fu_92_x_we1;
end behav;
