// q16_qksv2_d16.cpp — Q16-QKSv2-D16  Q/K physically pruned (ATTN_DIM=16)
//
// v2 ARCHITECTURE (different from v1):
//   Q[SEQ_LEN][ATTN_DIM] — physically 16×16, NOT 16×16
//   K[SEQ_LEN][ATTN_DIM] — physically 16×16
...
#include "q16_qksv2_d16.h"
#include "qks_v2_params_q16_qksv2_d16.h"
#include <cmath>
...
#pragma HLS ALLOCATION instances=mul limit=64 operation
    ...
    data_t Q[SEQ_LEN][ATTN_DIM];   // 16×16
