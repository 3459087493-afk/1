...
set id 1
set name q16_qksv2_d16_mul_mul_9s_16s_25_4_1
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler q16_qksv2_d16_q16_qksv2_d16_Pipeline_VITIS_LOOP_217_3_input_projection_weight_V_ROM_AUTO_1R BINDTYPE {storage} TYPE {rom} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_sext_ln216 \
    op interface \
    ports { sext_ln216 { I 13 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_ln222 \
    op interface \
    ports { add_ln222 { I 8 vector } } \
} "
}
