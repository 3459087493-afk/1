...
entity q16_qksv2_d14_q16_qksv2_d14_Pipeline_VITIS_LOOP_251_5 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of q16_qksv2_d14_q16_qksv2_d14_Pipeline_VITIS_LOOP_251_5 is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln251_fu_173_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal icmp_ln251_reg_201 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_block_pp0_stage0_11001 : BOOLEAN;
    signal empty_66_fu_185_p1 : STD_LOGIC_VECTOR (3 downto 0);
    signal empty_66_reg_205 : STD_LOGIC_VECTOR (3 downto 0);
    signal ap_enable_reg_pp0_iter0_reg : STD_LOGIC := '0';
    signal grp_layer_norm_1_fu_94_ap_start : STD_LOGIC;
    signal grp_layer_norm_1_fu_94_ap_done : STD_LOGIC;
    signal grp_layer_norm_1_fu_94_ap_idle : STD_LOGIC;
    signal grp_layer_norm_1_fu_94_ap_ready : STD_LOGIC;
    signal grp_layer_norm_1_fu_94_x_address0 : STD_LOGIC_VECTOR (7 downto 0);
    signal grp_layer_norm_1_fu_94_x_ce0 : STD_LOGIC;
    signal grp_layer_norm_1_fu_94_x_we0 : STD_LOGIC;
    signal grp_layer_norm_1_fu_94_x_d0 : STD_LOGIC_VECTOR (15 downto 0);
    signal grp_layer_norm_1_fu_94_x_address1 : STD_LOGIC_VECTOR (7 downto 0);
    signal grp_layer_norm_1_fu_94_x_ce1 : STD_LOGIC;
    signal grp_layer_norm_1_fu_94_x_we1 : STD_LOGIC;
    signal grp_layer_norm_1_fu_94_x_d1 : STD_LOGIC_VECTOR (15 downto 0);
    signal grp_layer_norm_1_fu_94_ap_start_reg : STD_LOGIC := '0';
    ...
    signal t_fu_90 : STD_LOGIC_VECTOR (4 downto 0);
    signal add_ln251_fu_179_p2 : STD_LOGIC_VECTOR (4 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal ap_sig_allocacmp_t_2 : STD_LOGIC_VECTOR (4 downto 0);
...
begin
    grp_layer_norm_1_fu_94 : component q16_qksv2_d14_layer_norm_1
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ap_start => grp_layer_norm_1_fu_94_ap_start,
        ap_done => grp_layer_norm_1_fu_94_ap_done,
        ap_idle => grp_layer_norm_1_fu_94_ap_idle,
        ap_ready => grp_layer_norm_1_fu_94_ap_ready,
        x_address0 => grp_layer_norm_1_fu_94_x_address0,
        x_ce0 => grp_layer_norm_1_fu_94_x_ce0,
        x_we0 => grp_layer_norm_1_fu_94_x_we0,
        x_d0 => grp_layer_norm_1_fu_94_x_d0,
        x_q0 => x_V_q0,
        x_address1 => grp_layer_norm_1_fu_94_x_address1,
        x_ce1 => grp_layer_norm_1_fu_94_x_ce1,
        x_we1 => grp_layer_norm_1_fu_94_x_we1,
        x_d1 => grp_layer_norm_1_fu_94_x_d1,
        x_q1 => x_V_q1,
        x_offset => empty_66_reg_205,
        p_read => ap_const_lv11_448,
        p_read1 => ap_const_lv11_2C7,
        p_read2 => ap_const_lv11_4A6,
        p_read3 => ap_const_lv11_3FC,
        p_read4 => ap_const_lv11_41C,
        p_read5 => ap_const_lv11_396,
        p_read6 => ap_const_lv8_C5,
        p_read7 => ap_const_lv8_A6,
        p_read8 => ap_const_lv7_63,
        p_read9 => ap_const_lv11_3AB,
        p_read10 => ap_const_lv11_4F9,
        ...
        p_read20 => ap_const_lv5_1,
        p_read21 => ap_const_lv6_24,
        p_read22 => ap_const_lv6_35,
        p_read23 => ap_const_lv5_9,
        p_read24 => ap_const_lv8_19,
        p_read25 => ap_const_lv6_5,
        p_read26 => ap_const_lv7_78,
        p_read27 => ap_const_lv4_7,
        p_read28 => ap_const_lv6_25,
        p_read29 => ap_const_lv5_17,
        p_read30 => ap_const_lv7_71,
    ...
    grp_layer_norm_1_fu_94_ap_start_reg_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                grp_layer_norm_1_fu_94_ap_start_reg <= ap_const_logic_0;
            else
                if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln251_fu_173_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) then 
                    grp_layer_norm_1_fu_94_ap_start_reg <= ap_const_logic_1;
                elsif ((grp_layer_norm_1_fu_94_ap_ready = ap_const_logic_1)) then 
                    grp_layer_norm_1_fu_94_ap_start_reg <= ap_const_logic_0;
                end if; 
            end if;
        end if;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                if (((icmp_ln251_fu_173_p2 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) then 
                    t_fu_90 <= add_ln251_fu_179_p2;
                elsif ((ap_loop_init = ap_const_logic_1)) then 
                    t_fu_90 <= ap_const_lv5_0;
                end if;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln251_fu_173_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                empty_66_reg_205 <= empty_66_fu_185_p1;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                icmp_ln251_reg_201 <= icmp_ln251_fu_173_p2;
            end if;
        end if;
    end process;
    ...
    add_ln251_fu_179_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_t_2) + unsigned(ap_const_lv5_1));
    ...
    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone, icmp_ln251_fu_173_p2)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln251_fu_173_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) then 
    ...
    ap_sig_allocacmp_t_2_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, t_fu_90, ap_loop_init)
    begin
        if (((ap_loop_init = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0))) then 
            ap_sig_allocacmp_t_2 <= ap_const_lv5_0;
        else 
            ap_sig_allocacmp_t_2 <= t_fu_90;
        end if; 
    end process;

    empty_66_fu_185_p1 <= ap_sig_allocacmp_t_2(4 - 1 downto 0);
    grp_layer_norm_1_fu_94_ap_start <= grp_layer_norm_1_fu_94_ap_start_reg;
    icmp_ln251_fu_173_p2 <= "1" when (ap_sig_allocacmp_t_2 = ap_const_lv5_10) else "0";
    x_V_address0 <= grp_layer_norm_1_fu_94_x_address0;
    x_V_address1 <= grp_layer_norm_1_fu_94_x_address1;
    x_V_ce0 <= grp_layer_norm_1_fu_94_x_ce0;
    x_V_ce1 <= grp_layer_norm_1_fu_94_x_ce1;
    x_V_d0 <= grp_layer_norm_1_fu_94_x_d0;
    x_V_d1 <= grp_layer_norm_1_fu_94_x_d1;
    x_V_we0 <= grp_layer_norm_1_fu_94_x_we0;
    x_V_we1 <= grp_layer_norm_1_fu_94_x_we1;
end behav;
