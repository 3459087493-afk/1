; ModuleID = '/home/cym/prj2/finn/notebooks/icl_thesis-master/experiments/imgds_linear_sparse/final_paper_experiments/experiment1_qks_v2_physical_prune/hls_projects/q16_qksv2_d14/q16_qksv2_d14_csynth/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_q16_qksv2_d14_ir([64 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="16" %input, %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"* noalias nocapture nonnull "fpga.decayed.dim.hint"="2" %logits) local_unnamed_addr #0 {
entry:
  ...
  call void @apatb_q16_qksv2_d14_hw([64 x i16]* %2, i16* %3)
...
declare void @apatb_q16_qksv2_d14_hw([64 x i16]*, i16*)
...
define void @q16_qksv2_d14_hw_stub_wrapper([64 x i16]*, i16*) #4 {
entry:
  ...
  call void @q16_qksv2_d14_hw_stub([64 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* %6, %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"* %7)
...
declare void @q16_qksv2_d14_hw_stub([64 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]*, %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"*)
