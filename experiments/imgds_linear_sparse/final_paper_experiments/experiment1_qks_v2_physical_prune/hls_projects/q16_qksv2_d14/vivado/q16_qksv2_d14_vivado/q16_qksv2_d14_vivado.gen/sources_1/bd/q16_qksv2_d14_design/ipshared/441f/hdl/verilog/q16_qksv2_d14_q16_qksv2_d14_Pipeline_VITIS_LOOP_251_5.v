...
module q16_qksv2_d14_q16_qksv2_d14_Pipeline_VITIS_LOOP_251_5 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [0:0] icmp_ln251_reg_201;
wire    ap_block_pp0_stage0_11001;
wire   [3:0] empty_66_fu_185_p1;
reg   [3:0] empty_66_reg_205;
reg    ap_enable_reg_pp0_iter0_reg;
wire    grp_layer_norm_1_fu_94_ap_start;
wire    grp_layer_norm_1_fu_94_ap_done;
wire    grp_layer_norm_1_fu_94_ap_idle;
wire    grp_layer_norm_1_fu_94_ap_ready;
wire   [7:0] grp_layer_norm_1_fu_94_x_address0;
wire    grp_layer_norm_1_fu_94_x_ce0;
wire    grp_layer_norm_1_fu_94_x_we0;
wire   [15:0] grp_layer_norm_1_fu_94_x_d0;
wire   [7:0] grp_layer_norm_1_fu_94_x_address1;
wire    grp_layer_norm_1_fu_94_x_ce1;
wire    grp_layer_norm_1_fu_94_x_we1;
wire   [15:0] grp_layer_norm_1_fu_94_x_d1;
reg    grp_layer_norm_1_fu_94_ap_start_reg;
...
#0 grp_layer_norm_1_fu_94_ap_start_reg = 1'b0;
#0 ap_done_reg = 1'b0;
end

q16_qksv2_d14_layer_norm_1 grp_layer_norm_1_fu_94(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        grp_layer_norm_1_fu_94_ap_start_reg <= 1'b0;
    end else begin
        if (((1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln251_fu_173_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            grp_layer_norm_1_fu_94_ap_start_reg <= 1'b1;
        end else if ((grp_layer_norm_1_fu_94_ap_ready == 1'b1)) begin
            grp_layer_norm_1_fu_94_ap_start_reg <= 1'b0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        if (((icmp_ln251_fu_173_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln251_fu_173_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln251_fu_173_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
assign add_ln251_fu_179_p2 = (ap_sig_allocacmp_t_2 + 5'd1);
...
assign empty_66_fu_185_p1 = ap_sig_allocacmp_t_2[3:0];

assign grp_layer_norm_1_fu_94_ap_start = grp_layer_norm_1_fu_94_ap_start_reg;

assign icmp_ln251_fu_173_p2 = ((ap_sig_allocacmp_t_2 == 5'd16) ? 1'b1 : 1'b0);

assign x_V_address0 = grp_layer_norm_1_fu_94_x_address0;

assign x_V_address1 = grp_layer_norm_1_fu_94_x_address1;

assign x_V_ce0 = grp_layer_norm_1_fu_94_x_ce0;

assign x_V_ce1 = grp_layer_norm_1_fu_94_x_ce1;

assign x_V_d0 = grp_layer_norm_1_fu_94_x_d0;

assign x_V_d1 = grp_layer_norm_1_fu_94_x_d1;

assign x_V_we0 = grp_layer_norm_1_fu_94_x_we0;

assign x_V_we1 = grp_layer_norm_1_fu_94_x_we1;

endmodule //q16_qksv2_d14_q16_qksv2_d14_Pipeline_VITIS_LOOP_251_5
