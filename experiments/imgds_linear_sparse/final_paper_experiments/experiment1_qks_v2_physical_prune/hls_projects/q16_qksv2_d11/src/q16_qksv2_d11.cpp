// q16_qksv2_d11.cpp — Q16-QKSv2-D11  Q/K physically pruned (ATTN_DIM=11)
//
// v2 ARCHITECTURE (different from v1):
//   Q[SEQ_LEN][ATTN_DIM] — physically 16×11, NOT 16×16
//   K[SEQ_LEN][ATTN_DIM] — physically 16×11
...
#include "q16_qksv2_d11.h"
#include "qks_v2_params_q16_qksv2_d11.h"
#include <cmath>
...
#pragma HLS ALLOCATION instances=mul limit=64 operation
    ...
    data_t Q[SEQ_LEN][ATTN_DIM];   // 16×11
