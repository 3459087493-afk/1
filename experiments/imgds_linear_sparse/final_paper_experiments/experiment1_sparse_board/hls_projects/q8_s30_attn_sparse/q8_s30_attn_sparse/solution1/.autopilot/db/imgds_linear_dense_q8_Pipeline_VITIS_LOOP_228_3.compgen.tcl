...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler imgds_linear_dense_q8_imgds_linear_dense_q8_Pipeline_VITIS_LOOP_228_3_input_projection_weight_V_ROMbkb BINDTYPE {storage} TYPE {rom} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_sext_ln227 \
    op interface \
    ports { sext_ln227 { I 13 vector } } \
} "
}
