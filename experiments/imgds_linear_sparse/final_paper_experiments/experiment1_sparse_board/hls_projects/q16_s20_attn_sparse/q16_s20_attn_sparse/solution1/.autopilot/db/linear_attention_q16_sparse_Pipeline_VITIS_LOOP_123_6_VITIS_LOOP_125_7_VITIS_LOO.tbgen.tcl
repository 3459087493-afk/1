set moduleName linear_attention_q16_sparse_Pipeline_VITIS_LOOP_123_6_VITIS_LOOP_125_7_VITIS_LOO
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {linear_attention_q16_sparse_Pipeline_VITIS_LOOP_123_6_VITIS_LOOP_125_7_VITIS_LOO}
set C_modelType { void 0 }
set C_modelArgList {
	{ KV_V int 16 regular {array 256 { 0 3 } 0 1 }  }
	{ K_V int 16 regular {array 256 { 1 3 } 1 1 }  }
	{ V_V int 16 regular {array 256 { 1 3 } 1 1 }  }
	{ ACTIVE_CHANNELS int 4 regular {array 13 { 1 } 1 1 } {global 0}  }
}
...
set portList { 
	...
	{ KV_V_address0 sc_out sc_lv 8 signal 0 } 
	{ KV_V_ce0 sc_out sc_logic 1 signal 0 } 
	{ KV_V_we0 sc_out sc_logic 1 signal 0 } 
	{ KV_V_d0 sc_out sc_lv 16 signal 0 } 
	{ K_V_address0 sc_out sc_lv 8 signal 1 } 
	{ K_V_ce0 sc_out sc_logic 1 signal 1 } 
	{ K_V_q0 sc_in sc_lv 16 signal 1 } 
	{ V_V_address0 sc_out sc_lv 8 signal 2 } 
	{ V_V_ce0 sc_out sc_logic 1 signal 2 } 
	{ V_V_q0 sc_in sc_lv 16 signal 2 } 
	{ ACTIVE_CHANNELS_address0 sc_out sc_lv 4 signal 3 } 
	{ ACTIVE_CHANNELS_ce0 sc_out sc_logic 1 signal 3 } 
	{ ACTIVE_CHANNELS_q0 sc_in sc_lv 4 signal 3 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "K_V_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "K_V", "role": "address0" }} , 
 	...
 	{ "name": "V_V_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "V_V", "role": "address0" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mac_muladd_16s_16s_30ns_30_4_1_U28", "Parent" : "0"},
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "3335", "Max" : "3335"}
	, {"Name" : "Interval", "Min" : "3335", "Max" : "3335"}
]}
...
set Spec2ImplPortList { 
	KV_V { ap_memory {  { KV_V_address0 mem_address 1 8 }  { KV_V_ce0 mem_ce 1 1 }  { KV_V_we0 mem_we 1 1 }  { KV_V_d0 mem_din 1 16 } } }
	K_V { ap_memory {  { K_V_address0 mem_address 1 8 }  { K_V_ce0 mem_ce 1 1 }  { K_V_q0 in_data 0 16 } } }
	V_V { ap_memory {  { V_V_address0 mem_address 1 8 }  { V_V_ce0 mem_ce 1 1 }  { V_V_q0 in_data 0 16 } } }
