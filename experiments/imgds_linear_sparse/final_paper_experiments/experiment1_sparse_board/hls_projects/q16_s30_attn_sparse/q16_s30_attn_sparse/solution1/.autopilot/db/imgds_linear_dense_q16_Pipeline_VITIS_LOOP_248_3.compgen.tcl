...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler imgds_linear_dense_q16_imgds_linear_dense_q16_Pipeline_VITIS_LOOP_248_3_input_projection_weight_V_RObkb BINDTYPE {storage} TYPE {rom} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_ln252_1 \
    op interface \
    ports { add_ln252_1 { I 8 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_sext_ln245 \
    op interface \
    ports { sext_ln245 { I 63 vector } } \
} "
}
