#!/usr/bin/env python3
"""
Q16 Main PYNQ-Z2 Full-Test Validation Script
=============================================
Re-validate Q16 Main (d=16, ff=32) on full IMG_DS 3444-sample test set.
...
Run on PYNQ-Z2:
    sudo python3 run_q16_main_pynq_full_test.py
"""
...
def reference_sanity_check():
    ...
    print("=" * 60)
    expected = {
        "full 3444": ("q16_main_test_3444.npz", 0.9419),
        "eval 200":  ("q16_main_eval200.npz",  0.9500),
        "sanity 1":  ("q16_main_sanity.npz",    None),
    }
...
# ---- Paths ----
BIT_FILE    = "q16_main.bit"
HWH_FILE    = "q16_main.hwh"
EVAL_200    = "q16_main_eval200.npz"
FULL_TEST   = "q16_main_test_3444.npz"
SANITY      = "q16_main_sanity.npz"
OUTPUT_CSV  = "q16_main_pynq_result.csv"
...
def main():
    ...
    print("=" * 60)
    print("Q16 Main PYNQ-Z2 FULL-TEST (3444 samples)")
    print("d_model=16  ff_dim=32  data_t=ap_fixed<16,6>")
    print("Vivado LUT=14,004  DSP=156  SW acc=94.19%")
    print("=" * 60)
    ...
    rows = [
        ("model_id", "Q16_Main"), ("d_model", 16), ("ff_dim", 32), ("quant_bits", 16),
        ("vivado_lut", 14004), ("vivado_dsp", 156), ("vivado_ff", 12903), ("vivado_bram", 15),
        ("software_accuracy", 0.9419),
        ...
        ("notes", f"Q16 Main (d=16/ff=32) PYNQ-Z2 full-test ({n} samples). "
    ...
    print("\nQ16 Main full PYNQ test complete.")
