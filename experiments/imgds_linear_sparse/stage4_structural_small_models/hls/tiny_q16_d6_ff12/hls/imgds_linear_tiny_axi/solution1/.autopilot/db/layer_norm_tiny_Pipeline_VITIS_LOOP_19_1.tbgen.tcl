set moduleName layer_norm_tiny_Pipeline_VITIS_LOOP_19_1
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {layer_norm_tiny_Pipeline_VITIS_LOOP_19_1}
set C_modelType { void 0 }
set C_modelArgList {
	{ x int 16 regular {array 6 { 1 3 } 1 1 }  }
	{ sum_V_out int 23 regular {pointer 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "x", "interface" : "memory", "bitwidth" : 16, "direction" : "READONLY"} , 
 	{ "Name" : "sum_V_out", "interface" : "wire", "bitwidth" : 23, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ sum_V_out sc_out sc_lv 23 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sum_V_out", "direction": "out", "datatype": "sc_lv", "bitwidth":23, "type": "signal", "bundle":{"name": "sum_V_out", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	sum_V_out { ap_vld {  { sum_V_out out_data 1 23 }  { sum_V_out_ap_vld out_vld 1 1 } } }
}
