...
HLS_SOURCES = ../../../../src/testbench.cpp ../../../../src/imgds_linear_tiny.cpp
...
$(ObjDir)/imgds_linear_tiny.o: ../../../../src/imgds_linear_tiny.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../src/imgds_linear_tiny.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/imgds_linear_tiny.d
