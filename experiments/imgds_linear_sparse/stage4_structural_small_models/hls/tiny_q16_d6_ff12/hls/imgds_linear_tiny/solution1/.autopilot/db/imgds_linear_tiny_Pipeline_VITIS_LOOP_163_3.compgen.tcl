...
set id 1
set name imgds_linear_tiny_mul_mul_9s_16s_25_4_1
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler imgds_linear_tiny_imgds_linear_tiny_Pipeline_VITIS_LOOP_163_3_input_projection_weight_V_ROM_AUTbkb BINDTYPE {storage} TYPE {rom} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}
