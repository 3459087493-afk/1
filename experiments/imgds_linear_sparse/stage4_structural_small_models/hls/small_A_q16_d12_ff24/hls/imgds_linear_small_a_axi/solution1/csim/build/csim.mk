...
HLS_SOURCES = ../../../../src/testbench.cpp ../../../../src/imgds_linear_small_a.cpp
...
$(ObjDir)/imgds_linear_small_a.o: ../../../../src/imgds_linear_small_a.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../src/imgds_linear_small_a.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/imgds_linear_small_a.d
