; ModuleID = '/home/cym/prj2/finn/notebooks/icl_thesis-master/experiments/imgds_linear_sparse/stage4_structural_small_models/hls/small_A_q16_d12_ff24/hls/imgds_linear_small_a_axi/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_imgds_linear_small_a_ir([64 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="16" %input, %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"* noalias nocapture nonnull "fpga.decayed.dim.hint"="2" %logits) local_unnamed_addr #0 {
entry:
  ...
  call void @apatb_imgds_linear_small_a_hw([64 x i16]* %2, i16* %3)
...
declare void @apatb_imgds_linear_small_a_hw([64 x i16]*, i16*)
...
define void @imgds_linear_small_a_hw_stub_wrapper([64 x i16]*, i16*) #4 {
entry:
  ...
  call void @imgds_linear_small_a_hw_stub([64 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* %6, %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"* %7)
...
declare void @imgds_linear_small_a_hw_stub([64 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]*, %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"*)
