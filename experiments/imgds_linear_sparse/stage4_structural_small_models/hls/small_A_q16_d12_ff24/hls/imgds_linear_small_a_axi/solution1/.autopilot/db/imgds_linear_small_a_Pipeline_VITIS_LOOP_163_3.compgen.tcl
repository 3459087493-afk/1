...
set id 1
set name imgds_linear_small_a_mul_mul_9s_16s_25_4_1
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler imgds_linear_small_a_imgds_linear_small_a_Pipeline_VITIS_LOOP_163_3_input_projection_weight_V_ROM_bkb BINDTYPE {storage} TYPE {rom} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename x_V \
    op interface \
    ports { x_V_address0 { O 8 vector } x_V_ce0 { O 1 bit } x_V_we0 { O 1 bit } x_V_d0 { O 16 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_sext_ln162 \
    op interface \
    ports { sext_ln162 { I 13 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_ln167_1 \
    op interface \
    ports { add_ln167_1 { I 8 vector } } \
} "
}
