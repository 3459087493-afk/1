...
module imgds_linear_small_b_imgds_linear_small_b_Pipeline_VITIS_LOOP_176_4 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [0:0] icmp_ln176_reg_139;
wire    ap_block_pp0_stage0_11001;
wire   [3:0] empty_72_fu_123_p1;
reg   [3:0] empty_72_reg_143;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln176_fu_111_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
assign add_ln176_fu_117_p2 = (ap_sig_allocacmp_s + 5'd1);
...
assign empty_72_fu_123_p1 = ap_sig_allocacmp_s[3:0];

assign grp_layer_norm_small_b_1_fu_64_ap_start = grp_layer_norm_small_b_1_fu_64_ap_start_reg;

assign icmp_ln176_fu_111_p2 = ((ap_sig_allocacmp_s == 5'd16) ? 1'b1 : 1'b0);
...
endmodule //imgds_linear_small_b_imgds_linear_small_b_Pipeline_VITIS_LOOP_176_4
