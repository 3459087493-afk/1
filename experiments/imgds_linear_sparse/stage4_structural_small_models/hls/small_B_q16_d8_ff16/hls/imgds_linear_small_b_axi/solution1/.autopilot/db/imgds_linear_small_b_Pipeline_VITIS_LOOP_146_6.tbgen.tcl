set moduleName imgds_linear_small_b_Pipeline_VITIS_LOOP_146_6
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {imgds_linear_small_b_Pipeline_VITIS_LOOP_146_6}
set C_modelType { void 0 }
set C_modelArgList {
	{ zext_ln1271_4 int 7 regular  }
	{ x_V int 16 regular {array 128 { 0 1 } 1 1 }  }
	{ ff_out_V int 16 regular {array 8 { 1 3 } 1 1 }  }
}
...
set Spec2ImplPortList { 
	...
	x_V { ap_memory {  { x_V_address0 mem_address 1 7 }  { x_V_ce0 mem_ce 1 1 }  { x_V_we0 mem_we 1 1 }  { x_V_d0 mem_din 1 16 }  { x_V_address1 MemPortADDR2 1 7 }  { x_V_ce1 MemPortCE2 1 1 }  { x_V_q1 in_data 0 16 } } }
	ff_out_V { ap_memory {  { ff_out_V_address0 mem_address 1 3 }  { ff_out_V_ce0 mem_ce 1 1 }  { ff_out_V_q0 in_data 0 16 } } }
}
