set moduleName layer_norm_small_b_Pipeline_VITIS_LOOP_27_3
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {layer_norm_small_b_Pipeline_VITIS_LOOP_27_3}
set C_modelType { void 0 }
set C_modelArgList {
	{ x int 16 regular {array 8 { 0 1 } 1 1 }  }
...
set RtlHierarchyInfo {[
	...
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.am_submul_16s_16s_16s_26_4_1_U148", "Parent" : "0"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mac_muladd_16s_11ns_19s_26_4_1_U149", "Parent" : "0"},
...
set Spec2ImplPortList { 
	x { ap_memory {  { x_address0 mem_address 1 3 }  { x_ce0 mem_ce 1 1 }  { x_we0 mem_we 1 1 }  { x_d0 mem_din 1 16 }  { x_address1 MemPortADDR2 1 3 }  { x_ce1 MemPortCE2 1 1 }  { x_q1 in_data 0 16 } } }
