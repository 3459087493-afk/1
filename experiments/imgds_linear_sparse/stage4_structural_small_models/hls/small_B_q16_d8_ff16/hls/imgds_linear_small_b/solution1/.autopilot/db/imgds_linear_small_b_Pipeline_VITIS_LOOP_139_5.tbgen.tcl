set moduleName imgds_linear_small_b_Pipeline_VITIS_LOOP_139_5
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {imgds_linear_small_b_Pipeline_VITIS_LOOP_139_5}
set C_modelType { void 0 }
set C_modelArgList {
	{ sext_ln138 int 13 regular  }
	{ ff_out_V int 16 regular {array 8 { 0 3 } 0 1 }  }
	{ zext_ln137 int 3 regular  }
	{ tmp_70 int 7 regular  }
	{ hidden_V int 15 regular {array 16 { 1 3 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "sext_ln138", "interface" : "wire", "bitwidth" : 13, "direction" : "READONLY"} , 
 	{ "Name" : "ff_out_V", "interface" : "memory", "bitwidth" : 16, "direction" : "WRITEONLY"} , 
 	{ "Name" : "zext_ln137", "interface" : "wire", "bitwidth" : 3, "direction" : "READONLY"} , 
 	{ "Name" : "tmp_70", "interface" : "wire", "bitwidth" : 7, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ sext_ln138 sc_in sc_lv 13 signal 0 } 
	{ ff_out_V_address0 sc_out sc_lv 3 signal 1 } 
	{ ff_out_V_ce0 sc_out sc_logic 1 signal 1 } 
	{ ff_out_V_we0 sc_out sc_logic 1 signal 1 } 
	{ ff_out_V_d0 sc_out sc_lv 16 signal 1 } 
	{ zext_ln137 sc_in sc_lv 3 signal 2 } 
	{ tmp_70 sc_in sc_lv 7 signal 3 } 
	{ hidden_V_address0 sc_out sc_lv 4 signal 4 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln138", "direction": "in", "datatype": "sc_lv", "bitwidth":13, "type": "signal", "bundle":{"name": "sext_ln138", "role": "default" }} , 
 	{ "name": "ff_out_V_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "ff_out_V", "role": "address0" }} , 
 	...
 	{ "name": "zext_ln137", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "zext_ln137", "role": "default" }} , 
 	{ "name": "tmp_70", "direction": "in", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "tmp_70", "role": "default" }} , 
 	{ "name": "hidden_V_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "hidden_V", "role": "address0" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_mul_11s_15ns_26_4_1_U128", "Parent" : "0"},
...
set Spec2ImplPortList { 
	sext_ln138 { ap_none {  { sext_ln138 in_data 0 13 } } }
	ff_out_V { ap_memory {  { ff_out_V_address0 mem_address 1 3 }  { ff_out_V_ce0 mem_ce 1 1 }  { ff_out_V_we0 mem_we 1 1 }  { ff_out_V_d0 mem_din 1 16 } } }
	zext_ln137 { ap_none {  { zext_ln137 in_data 0 3 } } }
	tmp_70 { ap_none {  { tmp_70 in_data 0 7 } } }
	hidden_V { ap_memory {  { hidden_V_address0 mem_address 1 4 }  { hidden_V_ce0 mem_ce 1 1 }  { hidden_V_q0 in_data 0 15 } } }
}
