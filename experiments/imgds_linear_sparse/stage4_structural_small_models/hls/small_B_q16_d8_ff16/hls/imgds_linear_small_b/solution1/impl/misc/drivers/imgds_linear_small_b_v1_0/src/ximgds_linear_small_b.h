...
// ==============================================================
#ifndef XIMGDS_LINEAR_SMALL_B_H
#define XIMGDS_LINEAR_SMALL_B_H
...
#include <stddef.h>
#endif
#include "ximgds_linear_small_b_hw.h"
...
} XImgds_linear_small_b_Config;
#endif

typedef struct {
    u64 Control_BaseAddress;
    u32 IsReady;
} XImgds_linear_small_b;

typedef u32 word_type;

/***************** Macros (Inline Functions) Definitions *********************/
#ifndef __linux__
#define XImgds_linear_small_b_WriteReg(BaseAddress, RegOffset, Data) \
    Xil_Out32((BaseAddress) + (RegOffset), (u32)(Data))
#define XImgds_linear_small_b_ReadReg(BaseAddress, RegOffset) \
