...
set id 1
set name imgds_linear_small_b_mul_mul_9s_16s_25_4_1
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler imgds_linear_small_b_imgds_linear_small_b_Pipeline_VITIS_LOOP_163_3_input_projection_weight_V_ROM_bkb BINDTYPE {storage} TYPE {rom} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename x_V \
    op interface \
    ports { x_V_address0 { O 7 vector } x_V_ce0 { O 1 bit } x_V_we0 { O 1 bit } x_V_d0 { O 16 vector } } \
} "
} else {
