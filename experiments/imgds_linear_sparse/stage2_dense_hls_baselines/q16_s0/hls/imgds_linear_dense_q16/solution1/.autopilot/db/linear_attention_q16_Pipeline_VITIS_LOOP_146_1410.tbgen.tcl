set moduleName linear_attention_q16_Pipeline_VITIS_LOOP_146_1410
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {linear_attention_q16_Pipeline_VITIS_LOOP_146_1410}
...
set C_modelArgList {
	...
	{ phi_ln818_10_out int 16 regular {pointer 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "attended_V_reload", "interface" : "wire", "bitwidth" : 16, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "phi_ln818_10_out", "interface" : "wire", "bitwidth" : 16, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ phi_ln818_10_out sc_out sc_lv 16 signal 16 } 
	{ phi_ln818_10_out_ap_vld sc_out sc_logic 1 outvld 16 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "phi_ln818_10_out", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "phi_ln818_10_out", "role": "default" }} , 
 	{ "name": "phi_ln818_10_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "phi_ln818_10_out", "role": "ap_vld" }}  ]}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_164_16_1_1_U2942", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_164_16_1_1_x9_U2943", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mac_muladd_16s_16s_30ns_30_4_1_U2944", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	phi_ln818_10_out { ap_vld {  { phi_ln818_10_out out_data 1 16 }  { phi_ln818_10_out_ap_vld out_vld 1 1 } } }
}
