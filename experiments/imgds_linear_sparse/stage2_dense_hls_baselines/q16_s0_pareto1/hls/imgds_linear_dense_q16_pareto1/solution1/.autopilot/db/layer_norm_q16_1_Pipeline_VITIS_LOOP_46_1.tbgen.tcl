set moduleName layer_norm_q16_1_Pipeline_VITIS_LOOP_46_1
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {layer_norm_q16.1_Pipeline_VITIS_LOOP_46_1}
...
set C_modelArgList {
	...
	{ sum_V_out int 24 regular {pointer 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "p_read", "interface" : "wire", "bitwidth" : 16, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "sum_V_out", "interface" : "wire", "bitwidth" : 24, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ sum_V_out sc_out sc_lv 24 signal 16 } 
	{ sum_V_out_ap_vld sc_out sc_logic 1 outvld 16 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sum_V_out", "direction": "out", "datatype": "sc_lv", "bitwidth":24, "type": "signal", "bundle":{"name": "sum_V_out", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_42_16_1_1_U3120", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_42_16_1_1_U3121", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_42_16_1_1_U3122", "Parent" : "0"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_42_16_1_1_U3123", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	sum_V_out { ap_vld {  { sum_V_out out_data 1 24 }  { sum_V_out_ap_vld out_vld 1 1 } } }
}
