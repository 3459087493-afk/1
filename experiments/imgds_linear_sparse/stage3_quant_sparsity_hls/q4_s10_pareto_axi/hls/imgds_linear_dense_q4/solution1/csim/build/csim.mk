...
HLS_SOURCES = ../../../../src/testbench.cpp ../../../../src/imgds_linear_dense_q4.cpp
...
$(ObjDir)/imgds_linear_dense_q4.o: ../../../../src/imgds_linear_dense_q4.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../src/imgds_linear_dense_q4.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/imgds_linear_dense_q4.d
