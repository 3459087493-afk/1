set moduleName imgds_linear_dense_q8_Pipeline_VITIS_LOOP_185_3
set isTopModule 0
...
set C_modelArgMapList {[ 
	{ "Name" : "sext_ln184", "interface" : "wire", "bitwidth" : 14, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "tmp_64", "interface" : "wire", "bitwidth" : 9, "direction" : "READONLY"} , 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "tmp_64", "direction": "in", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "tmp_64", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mac_muladd_16s_5s_24s_24_4_1_U143", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	tmp_64 { ap_none {  { tmp_64 in_data 0 9 } } }
