...
set id 1
set name imgds_linear_dense_q8_mac_muladd_16s_3s_24s_24_4_1
...
set ce_signed 0
set out_width 24
set arg_lists {i0 {16 1 +} i1 {3 1 +} m {19 1 +} i2 {24 1 +} p {24 1 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler imgds_linear_dense_q8_imgds_linear_dense_q8_Pipeline_VITIS_LOOP_234_3_input_projection_weight_V_ROMbkb BINDTYPE {storage} TYPE {rom} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_sext_ln233 \
    op interface \
    ports { sext_ln233 { I 13 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { sum_V_3_out { O 20 vector } sum_V_3_out_ap_vld { O 1 bit } } \
} "
}
