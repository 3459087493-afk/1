...
module imgds_linear_dense_q16_imgds_linear_dense_q16_Pipeline_VITIS_LOOP_254_4 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [0:0] icmp_ln254_reg_199;
wire    ap_block_pp0_stage0_11001;
wire   [3:0] empty_68_fu_183_p1;
reg   [3:0] empty_68_reg_203;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln254_fu_171_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        if (((icmp_ln254_fu_171_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln254_fu_171_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln254_fu_171_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
assign add_ln254_fu_177_p2 = (ap_sig_allocacmp_s + 5'd1);
...
assign empty_68_fu_183_p1 = ap_sig_allocacmp_s[3:0];

assign grp_layer_norm_q16_1_fu_92_ap_start = grp_layer_norm_q16_1_fu_92_ap_start_reg;

assign icmp_ln254_fu_171_p2 = ((ap_sig_allocacmp_s == 5'd16) ? 1'b1 : 1'b0);
...
endmodule //imgds_linear_dense_q16_imgds_linear_dense_q16_Pipeline_VITIS_LOOP_254_4
