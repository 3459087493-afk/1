...
**Sparsity:** 10% (14/16 active Q/K channels)
**Active channels:** [0, 1, 2, 3, 4, 6, 7, 8, 10, 11, 12, 13, 14, 15]
**Inactive (pruned) channels:** [5, 9]

**Software simulation accuracy:** 95.18%
**Baseline (Q16 S0 dense):** 94.43% SW accuracy

**Method:**
- Q/K attention accumulation loops truncated to ACTIVE_DIM=14
