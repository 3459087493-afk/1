...
set id 1
set name q16_qksv3_s20_mul_mul_9s_16s_25_4_1
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler q16_qksv3_s20_q16_qksv3_s20_Pipeline_VITIS_LOOP_222_3_input_projection_weight_V_ROM_AUTO_1R BINDTYPE {storage} TYPE {rom} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_ln227 \
    op interface \
    ports { add_ln227 { I 8 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_sext_ln222 \
    op interface \
    ports { sext_ln222 { I 63 vector } } \
} "
}
