// EXPLORATORY ONLY: Phase 1 failed accuracy and full-app monotonicity.
// Real compact input: ACTIVE_TOKENS=13; Q/K physical dimension: ATTN_DIM=13.
// q16_qksv3_s20.cpp — Q16-QKSv2-D13  Q/K physically pruned (ATTN_DIM=13)
//
// v2 ARCHITECTURE (different from v1):
//   Q[ACTIVE_TOKENS][ATTN_DIM] — physically 16×13, NOT 16×16
//   K[ACTIVE_TOKENS][ATTN_DIM] — physically 16×13
//   KV[ATTN_DIM][D_MODEL] — physically 13×16
//   K_sum[ATTN_DIM]       — physically 13
//   Wq_pruned[ATTN_DIM * D_MODEL] — physically 208
//   Wk_pruned[ATTN_DIM * D_MODEL] — physically 208
//
...
#include "q16_qksv3_s20.h"
#include "qks_v3_params_q16_qksv3_s20.h"
#include <cmath>
...
//  Q/K have 13 output channels; V/Wo/FFN stay 16
// ═══════════════════════════════════════════════════════════════════
static void attention_v2_pruned(
    data_t x[ACTIVE_TOKENS][D_MODEL],
...
#pragma HLS ALLOCATION instances=mul limit=64 operation
    ...
    data_t Q[ACTIVE_TOKENS][ATTN_DIM];   // 16×13
    data_t K[ACTIVE_TOKENS][ATTN_DIM];
    data_t V[ACTIVE_TOKENS][D_MODEL];    // FULL 16
...
#pragma HLS INTERFACE m_axi port=token_indices offset=slave bundle=gmem2 depth=13
...
#pragma HLS PIPELINE II=1
        ...
        pooled[d] = data_t(sum / data_t(ACTIVE_TOKENS));
    }
