...
entity q16_qksv3_s10_q16_qksv3_s10_Pipeline_VITIS_LOOP_256_5 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of q16_qksv3_s10_q16_qksv3_s10_Pipeline_VITIS_LOOP_256_5 is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln256_fu_175_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal t_2_reg_198 : STD_LOGIC_VECTOR (3 downto 0);
    signal ap_block_pp0_stage0_11001 : BOOLEAN;
    signal icmp_ln256_reg_203 : STD_LOGIC_VECTOR (0 downto 0);
    signal add_ln256_fu_181_p2 : STD_LOGIC_VECTOR (3 downto 0);
    signal add_ln256_reg_207 : STD_LOGIC_VECTOR (3 downto 0);
    signal ap_enable_reg_pp0_iter0_reg : STD_LOGIC := '0';
    signal grp_layer_norm_1_fu_96_ap_start : STD_LOGIC;
    signal grp_layer_norm_1_fu_96_ap_done : STD_LOGIC;
    signal grp_layer_norm_1_fu_96_ap_idle : STD_LOGIC;
    signal grp_layer_norm_1_fu_96_ap_ready : STD_LOGIC;
    signal grp_layer_norm_1_fu_96_x_address0 : STD_LOGIC_VECTOR (7 downto 0);
    signal grp_layer_norm_1_fu_96_x_ce0 : STD_LOGIC;
    signal grp_layer_norm_1_fu_96_x_we0 : STD_LOGIC;
    signal grp_layer_norm_1_fu_96_x_d0 : STD_LOGIC_VECTOR (15 downto 0);
    signal grp_layer_norm_1_fu_96_x_address1 : STD_LOGIC_VECTOR (7 downto 0);
    signal grp_layer_norm_1_fu_96_x_ce1 : STD_LOGIC;
    signal grp_layer_norm_1_fu_96_x_we1 : STD_LOGIC;
    signal grp_layer_norm_1_fu_96_x_d1 : STD_LOGIC_VECTOR (15 downto 0);
    signal grp_layer_norm_1_fu_96_ap_start_reg : STD_LOGIC := '0';
    ...
    signal t_fu_92 : STD_LOGIC_VECTOR (3 downto 0);
...
begin
    grp_layer_norm_1_fu_96 : component q16_qksv3_s10_layer_norm_1
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ap_start => grp_layer_norm_1_fu_96_ap_start,
        ap_done => grp_layer_norm_1_fu_96_ap_done,
        ap_idle => grp_layer_norm_1_fu_96_ap_idle,
        ap_ready => grp_layer_norm_1_fu_96_ap_ready,
        x_address0 => grp_layer_norm_1_fu_96_x_address0,
        x_ce0 => grp_layer_norm_1_fu_96_x_ce0,
        x_we0 => grp_layer_norm_1_fu_96_x_we0,
        x_d0 => grp_layer_norm_1_fu_96_x_d0,
        x_q0 => x_V_q0,
        x_address1 => grp_layer_norm_1_fu_96_x_address1,
        x_ce1 => grp_layer_norm_1_fu_96_x_ce1,
        x_we1 => grp_layer_norm_1_fu_96_x_we1,
        x_d1 => grp_layer_norm_1_fu_96_x_d1,
        x_q1 => x_V_q1,
        x_offset => t_2_reg_198,
    ...
    grp_layer_norm_1_fu_96_ap_start_reg_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                grp_layer_norm_1_fu_96_ap_start_reg <= ap_const_logic_0;
            else
                if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln256_fu_175_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) then 
                    grp_layer_norm_1_fu_96_ap_start_reg <= ap_const_logic_1;
                elsif ((grp_layer_norm_1_fu_96_ap_ready = ap_const_logic_1)) then 
                    grp_layer_norm_1_fu_96_ap_start_reg <= ap_const_logic_0;
                end if; 
            end if;
        end if;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_loop_init = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then 
                t_fu_92 <= ap_const_lv4_0;
            elsif (((ap_const_logic_1 = ap_CS_fsm_pp0_stage1) and (icmp_ln256_reg_203 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage1_11001) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) then 
                t_fu_92 <= add_ln256_reg_207;
            end if; 
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                add_ln256_reg_207 <= add_ln256_fu_181_p2;
                icmp_ln256_reg_203 <= icmp_ln256_fu_175_p2;
                t_2_reg_198 <= ap_sig_allocacmp_t_2;
            end if;
        end if;
    end process;
    ...
    add_ln256_fu_181_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_t_2) + unsigned(ap_const_lv4_1));
    ...
    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone, icmp_ln256_fu_175_p2)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln256_fu_175_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) then 
    ...
    ap_sig_allocacmp_t_2_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, t_fu_92, ap_loop_init)
    begin
        if (((ap_loop_init = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0))) then 
            ap_sig_allocacmp_t_2 <= ap_const_lv4_0;
        else 
            ap_sig_allocacmp_t_2 <= t_fu_92;
        end if; 
    end process;

    grp_layer_norm_1_fu_96_ap_start <= grp_layer_norm_1_fu_96_ap_start_reg;
    icmp_ln256_fu_175_p2 <= "1" when (ap_sig_allocacmp_t_2 = ap_const_lv4_E) else "0";
    x_V_address0 <= grp_layer_norm_1_fu_96_x_address0;
    x_V_address1 <= grp_layer_norm_1_fu_96_x_address1;
    x_V_ce0 <= grp_layer_norm_1_fu_96_x_ce0;
    x_V_ce1 <= grp_layer_norm_1_fu_96_x_ce1;
    x_V_d0 <= grp_layer_norm_1_fu_96_x_d0;
    x_V_d1 <= grp_layer_norm_1_fu_96_x_d1;
    x_V_we0 <= grp_layer_norm_1_fu_96_x_we0;
    x_V_we1 <= grp_layer_norm_1_fu_96_x_we1;
end behav;
