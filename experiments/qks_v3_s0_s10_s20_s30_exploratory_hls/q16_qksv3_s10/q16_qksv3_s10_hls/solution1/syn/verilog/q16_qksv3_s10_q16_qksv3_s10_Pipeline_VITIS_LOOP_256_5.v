...
module q16_qksv3_s10_q16_qksv3_s10_Pipeline_VITIS_LOOP_256_5 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [0:0] icmp_ln256_reg_203;
wire   [3:0] add_ln256_fu_181_p2;
reg   [3:0] add_ln256_reg_207;
reg    ap_enable_reg_pp0_iter0_reg;
wire    grp_layer_norm_1_fu_96_ap_start;
wire    grp_layer_norm_1_fu_96_ap_done;
wire    grp_layer_norm_1_fu_96_ap_idle;
wire    grp_layer_norm_1_fu_96_ap_ready;
wire   [7:0] grp_layer_norm_1_fu_96_x_address0;
wire    grp_layer_norm_1_fu_96_x_ce0;
wire    grp_layer_norm_1_fu_96_x_we0;
wire   [15:0] grp_layer_norm_1_fu_96_x_d0;
wire   [7:0] grp_layer_norm_1_fu_96_x_address1;
wire    grp_layer_norm_1_fu_96_x_ce1;
wire    grp_layer_norm_1_fu_96_x_we1;
wire   [15:0] grp_layer_norm_1_fu_96_x_d1;
reg    grp_layer_norm_1_fu_96_ap_start_reg;
...
#0 grp_layer_norm_1_fu_96_ap_start_reg = 1'b0;
#0 ap_done_reg = 1'b0;
end

q16_qksv3_s10_layer_norm_1 grp_layer_norm_1_fu_96(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        grp_layer_norm_1_fu_96_ap_start_reg <= 1'b0;
    end else begin
        if (((1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln256_fu_175_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            grp_layer_norm_1_fu_96_ap_start_reg <= 1'b1;
        end else if ((grp_layer_norm_1_fu_96_ap_ready == 1'b1)) begin
            grp_layer_norm_1_fu_96_ap_start_reg <= 1'b0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        t_fu_92 <= 4'd0;
    end else if (((1'b1 == ap_CS_fsm_pp0_stage1) & (icmp_ln256_reg_203 == 1'd0) & (1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln256_fu_175_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
assign add_ln256_fu_181_p2 = (ap_sig_allocacmp_t_2 + 4'd1);
...
assign grp_layer_norm_1_fu_96_ap_start = grp_layer_norm_1_fu_96_ap_start_reg;

assign icmp_ln256_fu_175_p2 = ((ap_sig_allocacmp_t_2 == 4'd14) ? 1'b1 : 1'b0);

assign x_V_address0 = grp_layer_norm_1_fu_96_x_address0;

assign x_V_address1 = grp_layer_norm_1_fu_96_x_address1;

assign x_V_ce0 = grp_layer_norm_1_fu_96_x_ce0;

assign x_V_ce1 = grp_layer_norm_1_fu_96_x_ce1;

assign x_V_d0 = grp_layer_norm_1_fu_96_x_d0;

assign x_V_d1 = grp_layer_norm_1_fu_96_x_d1;

assign x_V_we0 = grp_layer_norm_1_fu_96_x_we0;

assign x_V_we1 = grp_layer_norm_1_fu_96_x_we1;

endmodule //q16_qksv3_s10_q16_qksv3_s10_Pipeline_VITIS_LOOP_256_5
