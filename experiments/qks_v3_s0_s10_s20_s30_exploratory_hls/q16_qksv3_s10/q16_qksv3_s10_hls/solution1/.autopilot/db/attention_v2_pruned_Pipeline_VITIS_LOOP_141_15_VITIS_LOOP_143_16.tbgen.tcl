set moduleName attention_v2_pruned_Pipeline_VITIS_LOOP_141_15_VITIS_LOOP_143_16
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {attention_v2_pruned_Pipeline_VITIS_LOOP_141_15_VITIS_LOOP_143_16}
set C_modelType { void 0 }
set C_modelArgList {
	{ sub_ln1271_1 int 8 regular  }
	{ Q_V int 16 regular {array 196 { 1 3 } 1 1 }  }
	{ KV_V int 16 regular {array 224 { 1 3 } 1 1 }  }
	{ sext_ln1270_23 int 16 regular  }
	{ attended_V int 16 regular {array 16 { 0 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "sub_ln1271_1", "interface" : "wire", "bitwidth" : 8, "direction" : "READONLY"} , 
 	{ "Name" : "Q_V", "interface" : "memory", "bitwidth" : 16, "direction" : "READONLY"} , 
 	{ "Name" : "KV_V", "interface" : "memory", "bitwidth" : 16, "direction" : "READONLY"} , 
 	{ "Name" : "sext_ln1270_23", "interface" : "wire", "bitwidth" : 16, "direction" : "READONLY"} , 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sub_ln1271_1", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "sub_ln1271_1", "role": "default" }} , 
 	...
 	{ "name": "KV_V_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "KV_V", "role": "address0" }} , 
 	...
 	{ "name": "sext_ln1270_23", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "sext_ln1270_23", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mac_muladd_16s_16s_30ns_30_4_1_U44", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_mul_24s_16s_30_4_1_U45", "Parent" : "0"},
...
set Spec2ImplPortList { 
	sub_ln1271_1 { ap_none {  { sub_ln1271_1 in_data 0 8 } } }
	Q_V { ap_memory {  { Q_V_address0 mem_address 1 8 }  { Q_V_ce0 mem_ce 1 1 }  { Q_V_q0 in_data 0 16 } } }
	KV_V { ap_memory {  { KV_V_address0 mem_address 1 8 }  { KV_V_ce0 mem_ce 1 1 }  { KV_V_q0 in_data 0 16 } } }
	sext_ln1270_23 { ap_none {  { sext_ln1270_23 in_data 0 16 } } }
	attended_V { ap_memory {  { attended_V_address0 mem_address 1 4 }  { attended_V_ce0 mem_ce 1 1 }  { attended_V_we0 mem_we 1 1 }  { attended_V_d0 mem_din 1 16 } } }
}
