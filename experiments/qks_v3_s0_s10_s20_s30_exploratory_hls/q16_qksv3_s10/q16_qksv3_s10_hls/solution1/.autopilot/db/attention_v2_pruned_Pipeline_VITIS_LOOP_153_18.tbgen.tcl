...
set C_modelArgList {
	...
	{ x int 16 regular {array 224 { 0 1 } 1 1 }  }
	{ add_ln813_18 int 8 regular  }
	{ tmp_111 int 8 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "sext_ln152", "interface" : "wire", "bitwidth" : 11, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "tmp_111", "interface" : "wire", "bitwidth" : 8, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ tmp_111 sc_in sc_lv 8 signal 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "tmp_111", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "tmp_111", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	tmp_111 { ap_none {  { tmp_111 in_data 0 8 } } }
