...
// Real compact input: ACTIVE_TOKENS=14; Q/K physical dimension: ATTN_DIM=14.
// q16_qksv3_s10.cpp — Q16-QKSv2-D14  Q/K physically pruned (ATTN_DIM=14)
//
// v2 ARCHITECTURE (different from v1):
//   Q[ACTIVE_TOKENS][ATTN_DIM] — physically 16×14, NOT 16×16
//   K[ACTIVE_TOKENS][ATTN_DIM] — physically 16×14
...
#include "qks_v3_params_q16_qksv3_s10.h"
#include <cmath>
...
#pragma HLS ALLOCATION instances=mul limit=64 operation
    ...
    data_t Q[ACTIVE_TOKENS][ATTN_DIM];   // 16×14
...
#pragma HLS INTERFACE m_axi port=token_indices offset=slave bundle=gmem2 depth=14
