...
// Real compact input: ACTIVE_TOKENS=11; Q/K physical dimension: ATTN_DIM=11.
// q16_qksv3_s30.cpp — Q16-QKSv2-D11  Q/K physically pruned (ATTN_DIM=11)
//
// v2 ARCHITECTURE (different from v1):
//   Q[ACTIVE_TOKENS][ATTN_DIM] — physically 16×11, NOT 16×16
//   K[ACTIVE_TOKENS][ATTN_DIM] — physically 16×11
//   KV[ATTN_DIM][D_MODEL] — physically 11×16
//   K_sum[ATTN_DIM]       — physically 11
//   Wq_pruned[ATTN_DIM * D_MODEL] — physically 176
//   Wk_pruned[ATTN_DIM * D_MODEL] — physically 176
//
...
#include "q16_qksv3_s30.h"
#include "qks_v3_params_q16_qksv3_s30.h"
#include <cmath>
...
//  Q/K have 11 output channels; V/Wo/FFN stay 16
// ═══════════════════════════════════════════════════════════════════
...
#pragma HLS ALLOCATION instances=mul limit=64 operation
    ...
    data_t Q[ACTIVE_TOKENS][ATTN_DIM];   // 16×11
...
#pragma HLS INTERFACE m_axi port=token_indices offset=slave bundle=gmem2 depth=11
