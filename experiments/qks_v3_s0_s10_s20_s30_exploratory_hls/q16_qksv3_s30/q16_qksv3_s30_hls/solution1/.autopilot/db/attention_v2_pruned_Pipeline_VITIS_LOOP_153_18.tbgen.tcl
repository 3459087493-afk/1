...
set C_modelArgList {
	...
	{ x int 16 regular {array 176 { 0 1 } 1 1 }  }
	{ add_ln813_18 int 8 regular  }
	{ tmp_103 int 8 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "sext_ln152", "interface" : "wire", "bitwidth" : 11, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "tmp_103", "interface" : "wire", "bitwidth" : 8, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ tmp_103 sc_in sc_lv 8 signal 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "tmp_103", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "tmp_103", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_mul_10s_16s_26_4_1_U54", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	tmp_103 { ap_none {  { tmp_103 in_data 0 8 } } }
