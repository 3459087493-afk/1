...
module q16_qksv3_s0_q16_qksv3_s0_Pipeline_VITIS_LOOP_256_5 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [0:0] icmp_ln256_reg_201;
wire    ap_block_pp0_stage0_11001;
wire   [3:0] empty_69_fu_185_p1;
reg   [3:0] empty_69_reg_205;
...
q16_qksv3_s0_layer_norm_1 grp_layer_norm_1_fu_94(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln256_fu_173_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        if (((icmp_ln256_fu_173_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln256_fu_173_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln256_fu_173_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
assign add_ln256_fu_179_p2 = (ap_sig_allocacmp_t_2 + 5'd1);
...
assign empty_69_fu_185_p1 = ap_sig_allocacmp_t_2[3:0];

assign grp_layer_norm_1_fu_94_ap_start = grp_layer_norm_1_fu_94_ap_start_reg;

assign icmp_ln256_fu_173_p2 = ((ap_sig_allocacmp_t_2 == 5'd16) ? 1'b1 : 1'b0);
...
endmodule //q16_qksv3_s0_q16_qksv3_s0_Pipeline_VITIS_LOOP_256_5
