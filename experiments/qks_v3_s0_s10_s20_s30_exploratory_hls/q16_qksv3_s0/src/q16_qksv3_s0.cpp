...
// Real compact input: ACTIVE_TOKENS=16; Q/K physical dimension: ATTN_DIM=16.
// q16_qksv3_s0.cpp — Q16-QKSv2-D16  Q/K physically pruned (ATTN_DIM=16)
//
// v2 ARCHITECTURE (different from v1):
//   Q[ACTIVE_TOKENS][ATTN_DIM] — physically 16×16, NOT 16×16
//   K[ACTIVE_TOKENS][ATTN_DIM] — physically 16×16
//   KV[ATTN_DIM][D_MODEL] — physically 16×16
//   K_sum[ATTN_DIM]       — physically 16
//   Wq_pruned[ATTN_DIM * D_MODEL] — physically 256
//   Wk_pruned[ATTN_DIM * D_MODEL] — physically 256
//
...
#include "q16_qksv3_s0.h"
#include "qks_v3_params_q16_qksv3_s0.h"
#include <cmath>
...
//  Q/K have 16 output channels; V/Wo/FFN stay 16
// ═══════════════════════════════════════════════════════════════════
...
#pragma HLS ALLOCATION instances=mul limit=64 operation
    ...
    data_t Q[ACTIVE_TOKENS][ATTN_DIM];   // 16×16
...
#pragma HLS INTERFACE m_axi port=token_indices offset=slave bundle=gmem2 depth=16
