...
- Feature-map mode: `pwl_elu_plus_one_3_segment`
- Scheduling mode: `resource_aware_limited_operators_pipeline`
- Difference from float baseline: v02 plus a three-segment PWL ELU+1 approximation and bounded resource-aware scheduling pragmas.
- PyTorch reference logits: `../../results/hls_generation/reference_logits/full_csg_halt_reference_logits.npy`
...
```bash
cd /home/cym/prj2/finn/notebooks/icl_thesis-master/experiments/innovation1_csg_halt/hls_variants/v03_full_csg_halt
