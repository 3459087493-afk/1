set moduleName unsw_linear_transformer_Pipeline_VITIS_LOOP_115_7_VITIS_LOOP_116_8
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {unsw_linear_transformer_Pipeline_VITIS_LOOP_115_7_VITIS_LOOP_116_8}
set C_modelType { void 0 }
set C_modelArgList {
	{ sparse_query float 32 regular {array 112 { 0 3 } 0 1 }  }
	{ sparse_key float 32 regular {array 112 { 0 3 3 3 3 3 3 3 3 3 3 3 3 3 3 3 3 } 0 1 }  }
	{ query float 32 regular {array 128 { 1 3 } 1 1 }  }
	{ key float 32 regular {array 128 { 1 3 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "sparse_query", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "sparse_key", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ sparse_query_address0 sc_out sc_lv 7 signal 0 } 
	{ sparse_query_ce0 sc_out sc_logic 1 signal 0 } 
	{ sparse_query_we0 sc_out sc_logic 1 signal 0 } 
	{ sparse_query_d0 sc_out sc_lv 32 signal 0 } 
	{ sparse_key_address0 sc_out sc_lv 7 signal 1 } 
	{ sparse_key_ce0 sc_out sc_logic 1 signal 1 } 
	{ sparse_key_we0 sc_out sc_logic 1 signal 1 } 
	{ sparse_key_d0 sc_out sc_lv 32 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sparse_query_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "sparse_query", "role": "we0" }} , 
 	{ "name": "sparse_query_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "sparse_query", "role": "d0" }} , 
 	...
 	{ "name": "sparse_key_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "sparse_key", "role": "we0" }} , 
 	{ "name": "sparse_key_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "sparse_key", "role": "d0" }} , 
...
set Spec2ImplPortList { 
	sparse_query { ap_memory {  { sparse_query_address0 mem_address 1 7 }  { sparse_query_ce0 mem_ce 1 1 }  { sparse_query_we0 mem_we 1 1 }  { sparse_query_d0 mem_din 1 32 } } }
	sparse_key { ap_memory {  { sparse_key_address0 mem_address 1 7 }  { sparse_key_ce0 mem_ce 1 1 }  { sparse_key_we0 mem_we 1 1 }  { sparse_key_d0 mem_din 1 32 } } }
	query { ap_memory {  { query_address0 mem_address 1 7 }  { query_ce0 mem_ce 1 1 }  { query_q0 in_data 0 32 } } }
	key { ap_memory {  { key_address0 mem_address 1 7 }  { key_ce0 mem_ce 1 1 }  { key_q0 in_data 0 32 } } }
}
