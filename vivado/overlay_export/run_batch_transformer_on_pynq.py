...
def parse_args():
    parser = argparse.ArgumentParser(description="Run transformer overlay on a CSV batch.")
    parser.add_argument("--input-csv", default="validation_samples.csv")
    parser.add_argument("--output-csv", default="fpga_results.csv")
    parser.add_argument("--bitfile", default="transformer.bit")
