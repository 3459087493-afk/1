set moduleName linear_attention_q8_Pipeline_VITIS_LOOP_97_3
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {linear_attention_q8_Pipeline_VITIS_LOOP_97_3}
set C_modelType { void 0 }
set C_modelArgList {
	{ zext_ln99 int 8 regular  }
	{ x int 16 regular {array 256 { 1 3 } 1 1 }  }
	{ tmp_4 int 8 regular  }
	{ sv_V_out int 20 regular {pointer 1}  }
	{ sq_V_out int 20 regular {pointer 1}  }
	{ sk_V_out int 20 regular {pointer 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "zext_ln99", "interface" : "wire", "bitwidth" : 8, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "sv_V_out", "interface" : "wire", "bitwidth" : 20, "direction" : "WRITEONLY"} , 
 	{ "Name" : "sq_V_out", "interface" : "wire", "bitwidth" : 20, "direction" : "WRITEONLY"} , 
 	{ "Name" : "sk_V_out", "interface" : "wire", "bitwidth" : 20, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ zext_ln99 sc_in sc_lv 8 signal 0 } 
	{ x_address0 sc_out sc_lv 8 signal 1 } 
	{ x_ce0 sc_out sc_logic 1 signal 1 } 
	{ x_q0 sc_in sc_lv 16 signal 1 } 
	{ tmp_4 sc_in sc_lv 8 signal 2 } 
	{ sv_V_out sc_out sc_lv 20 signal 3 } 
	{ sv_V_out_ap_vld sc_out sc_logic 1 outvld 3 } 
	{ sq_V_out sc_out sc_lv 20 signal 4 } 
	{ sq_V_out_ap_vld sc_out sc_logic 1 outvld 4 } 
	{ sk_V_out sc_out sc_lv 20 signal 5 } 
	{ sk_V_out_ap_vld sc_out sc_logic 1 outvld 5 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sv_V_out", "direction": "out", "datatype": "sc_lv", "bitwidth":20, "type": "signal", "bundle":{"name": "sv_V_out", "role": "default" }} , 
 	{ "name": "sv_V_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "sv_V_out", "role": "ap_vld" }} , 
 	{ "name": "sq_V_out", "direction": "out", "datatype": "sc_lv", "bitwidth":20, "type": "signal", "bundle":{"name": "sq_V_out", "role": "default" }} , 
 	{ "name": "sq_V_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "sq_V_out", "role": "ap_vld" }} , 
 	{ "name": "sk_V_out", "direction": "out", "datatype": "sc_lv", "bitwidth":20, "type": "signal", "bundle":{"name": "sk_V_out", "role": "default" }} , 
 	{ "name": "sk_V_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "sk_V_out", "role": "ap_vld" }}  ]}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mac_muladd_16s_6s_24s_24_4_1_U9", "Parent" : "0"},
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mac_muladd_16s_5s_24s_24_4_1_U10", "Parent" : "0"},
	{"ID" : "6", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mac_muladd_16s_4s_24s_24_4_1_U11", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	x { ap_memory {  { x_address0 mem_address 1 8 }  { x_ce0 mem_ce 1 1 }  { x_q0 in_data 0 16 } } }
	tmp_4 { ap_none {  { tmp_4 in_data 0 8 } } }
	sv_V_out { ap_vld {  { sv_V_out out_data 1 20 }  { sv_V_out_ap_vld out_vld 1 1 } } }
	sq_V_out { ap_vld {  { sq_V_out out_data 1 20 }  { sq_V_out_ap_vld out_vld 1 1 } } }
	sk_V_out { ap_vld {  { sk_V_out out_data 1 20 }  { sk_V_out_ap_vld out_vld 1 1 } } }
}
