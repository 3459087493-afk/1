...
HLS_SOURCES = ../../../../src/testbench.cpp ../../../../src/imgds_linear_dense_q8.cpp
...
$(ObjDir)/imgds_linear_dense_q8.o: ../../../../src/imgds_linear_dense_q8.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../src/imgds_linear_dense_q8.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/imgds_linear_dense_q8.d
