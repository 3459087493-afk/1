...
EAStep vivado -log imgds_linear_dense_q16_q16_s20_attn_sparse_design_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source imgds_linear_dense_q16_q16_s20_attn_sparse_design_auto_pc_0.tcl
