...
EAStep vivado -log imgds_linear_dense_q8_q8_s30_attn_sparse_design_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source imgds_linear_dense_q8_q8_s30_attn_sparse_design_processing_system7_0_0.tcl
