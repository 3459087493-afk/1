...
int main() {
    ...
    printf("Q16-S0-PARETO2 CSIM Testbench\n");
    printf("==================================================\n");
    ...
    printf("\n");
    printf("==================================================\n");
    printf("Q16-S0-PARETO2  CSIM Results (N=%d)\n", N_EVAL_SAMPLES);
    printf("==================================================\n");
    ...
    printf("\n==================================================\n");
    printf("  strict_threshold_0p99  : %s\n", strict_pass  ? "PASS" : "FAIL");
    printf("  relaxed_threshold_0p98 : %s\n", relaxed_pass ? "PASS" : "FAIL");
    printf("==================================================\n");

    if (relaxed_pass)
        printf("\nCSIM PASSED (relaxed). HW accuracy=%.4f.\n", hw_accuracy);
    else
        printf("\nCSIM FAILED.\n");
