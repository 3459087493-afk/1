# Vivado TCL for q16_s10_attn_sparse — auto-generated
set origin_dir [file normalize [file dirname [info script]]]
set project_dir [file join $origin_dir q16_s10_attn_sparse_vivado_prj]
set board_repo  /home/cym/prj2/finn/deps/board_files
set design_name imgds_linear_dense_q16_q16_s10_attn_sparse_design

puts "============================================"
puts "q16_s10_attn_sparse Vivado Build"
puts "============================================"
puts "IP repo : /home/cym/prj2/finn/notebooks/icl_thesis-master/experiments/imgds_linear_sparse/final_paper_experiments/experiment1_sparse_board/hls_projects/q16_s10_attn_sparse/q16_s10_attn_sparse/solution1/impl/ip"
puts "Board   : /home/cym/prj2/finn/deps/board_files"

set_param board.repoPaths [list $board_repo]
create_project q16_s10_attn_sparse_vivado_prj $project_dir -part xc7z020clg400-1 -force
set_property board_part tul.com.tw:pynq-z2:part0:1.0 [current_project]
set_property ip_repo_paths [list /home/cym/prj2/finn/notebooks/icl_thesis-master/experiments/imgds_linear_sparse/final_paper_experiments/experiment1_sparse_board/hls_projects/q16_s10_attn_sparse/q16_s10_attn_sparse/solution1/impl/ip] [current_project]
update_ip_catalog
...
add_files -norecurse [file join $project_dir q16_s10_attn_sparse_vivado_prj.gen sources_1 bd $design_name hdl ${design_name}_wrapper.v]
...
# ---- Copy .bit and .hwh ----
set bit_file [file join $project_dir q16_s10_attn_sparse_vivado_prj.runs impl_1 ${design_name}_wrapper.bit]
set hwh_file [file join $project_dir q16_s10_attn_sparse_vivado_prj.gen sources_1 bd $design_name hw_handoff ${design_name}.hwh]

if {![file exists $bit_file]} { error "Bitstream NOT found: $bit_file" }
if {![file exists $hwh_file]} { error "HWH NOT found: $hwh_file" }

file copy -force $bit_file [file join $origin_dir q16_s10_attn_sparse.bit]
file copy -force $hwh_file [file join $origin_dir q16_s10_attn_sparse.hwh]

puts "BIT: [file join $origin_dir q16_s10_attn_sparse.bit]"
puts "HWH: [file join $origin_dir q16_s10_attn_sparse.hwh]"

puts "============================================"
puts "q16_s10_attn_sparse Vivado build COMPLETE"
puts "Bit: [file join $origin_dir q16_s10_attn_sparse.bit]"
puts "HWH: [file join $origin_dir q16_s10_attn_sparse.hwh]"
puts "============================================"
