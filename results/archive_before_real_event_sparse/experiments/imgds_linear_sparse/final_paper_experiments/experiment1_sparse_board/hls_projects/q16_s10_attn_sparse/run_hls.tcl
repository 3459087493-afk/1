# run_hls.tcl — Q16-S10 AttnSparse — CSIM + CSYNTH + IP Export
# AXI interface: m_axi gmem0 (input) + m_axi gmem1 (logits) + s_axilite control
open_project q16_s10_attn_sparse
