#!/usr/bin/env python3
"""
Ours-Q8-S0-AttnSparse PYNQ-Z2 Full-Test
=============================================
Validate Ours-Q8-S0-AttnSparse (d=16, ff=32, ACTIVE_DIM=16) on full IMG_DS 3444-sample test set.
...
Run on PYNQ-Z2:
    sudo python3 run_q8_s0_attn_sparse_pynq_full_test.py
"""
...
def reference_sanity_check():
    ...
    print("=" * 60)
    expected = {
        "full 3444": ("q8_s0_attn_sparse_test_3444.npz", 0.9419),
        "eval 200":  ("q8_s0_attn_sparse_eval200.npz",  0.9500),
        "sanity 1":  ("q8_s0_attn_sparse_sanity.npz",    None),
    }
...
# ---- Paths ----
BIT_FILE    = "q8_s0_attn_sparse.bit"
HWH_FILE    = "q8_s0_attn_sparse.hwh"
EVAL_200    = "q8_s0_attn_sparse_eval200.npz"
FULL_TEST   = "q8_s0_attn_sparse_test_3444.npz"
SANITY      = "q8_s0_attn_sparse_sanity.npz"
OUTPUT_CSV  = "q8_s0_attn_sparse_pynq_result.csv"
...
# ---- Ours-Q8-S0-AttnSparse constants ----
SEQ_LEN      = 16
INPUT_DIM    = 64
N_CLASSES    = 2
...
def main():
    ...
    print("=" * 60)
    print("Ours-Q8-S0-AttnSparse PYNQ-Z2 FULL-TEST")
    print("d_model=16  ff_dim=32  ACTIVE_DIM=16  sparsity=0%")
    print("Vivado LUT=14019  DSP=124  SW acc=0.91")
    print("=" * 60)
    ...
    rows = [
        ("model_id", "Ours-Q8-S0-AttnSparse"), ("d_model", 16), ("ff_dim", 32), ("quant_bits", 16),
        ...
        ("notes", f"Ours-Q8-S0-AttnSparse (d=16/ff=32) PYNQ-Z2 full-test ({n} samples). "
    ...
    print("\nOurs-Q8-S0-AttnSparse full PYNQ test complete.")
