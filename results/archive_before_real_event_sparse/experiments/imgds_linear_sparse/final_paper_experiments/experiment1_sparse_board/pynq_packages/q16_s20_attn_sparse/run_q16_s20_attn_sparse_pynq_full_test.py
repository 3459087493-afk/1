#!/usr/bin/env python3
"""
Ours-Q16-S20-AttnSparse PYNQ-Z2 Full-Test
=============================================
Validate Ours-Q16-S20-AttnSparse (d=16, ff=32, ACTIVE_DIM=13) on full IMG_DS 3444-sample test set.
...
Run on PYNQ-Z2:
    sudo python3 run_q16_s20_attn_sparse_pynq_full_test.py
"""
...
def reference_sanity_check():
    ...
    print("=" * 60)
    expected = {
        "full 3444": ("q16_s20_attn_sparse_test_3444.npz", 0.9419),
        "eval 200":  ("q16_s20_attn_sparse_eval200.npz",  0.9500),
        "sanity 1":  ("q16_s20_attn_sparse_sanity.npz",    None),
    }
...
# ---- Paths ----
BIT_FILE    = "q16_s20_attn_sparse.bit"
HWH_FILE    = "q16_s20_attn_sparse.hwh"
EVAL_200    = "q16_s20_attn_sparse_eval200.npz"
FULL_TEST   = "q16_s20_attn_sparse_test_3444.npz"
SANITY      = "q16_s20_attn_sparse_sanity.npz"
OUTPUT_CSV  = "q16_s20_attn_sparse_pynq_result.csv"
...
# ---- Ours-Q16-S20-AttnSparse constants ----
SEQ_LEN      = 16
INPUT_DIM    = 64
N_CLASSES    = 2
...
def main():
    ...
    print("=" * 60)
    print("Ours-Q16-S20-AttnSparse PYNQ-Z2 FULL-TEST")
    print("d_model=16  ff_dim=32  ACTIVE_DIM=13  sparsity=18.75%")
    print("Vivado LUT=TBD  DSP=TBD  SW acc=0.9515")
    print("=" * 60)
    ...
    rows = [
        ("model_id", "Ours-Q16-S20-AttnSparse"), ("d_model", 16), ("ff_dim", 32), ("quant_bits", 16),
        ("vivado_lut", TBD), ("vivado_dsp", TBD), ("vivado_ff", TBD), ("vivado_bram", TBD),
        ("software_accuracy", 0.9515),
        ...
        ("notes", f"Ours-Q16-S20-AttnSparse (d=16/ff=32) PYNQ-Z2 full-test ({n} samples). "
    ...
    print("\nOurs-Q16-S20-AttnSparse full PYNQ test complete.")
