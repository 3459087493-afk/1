...
**Sparsity:** 30% (11/16 active Q/K channels)
**Active channels:** [3, 4, 6, 7, 8, 10, 11, 12, 13, 14, 15]
**Inactive (pruned) channels:** [0, 1, 2, 5, 9]

**Software simulation accuracy:** 95.21%
**Baseline (Q16 S0 dense):** 94.43% SW accuracy

**Method:**
- Q/K attention accumulation loops truncated to ACTIVE_DIM=11
