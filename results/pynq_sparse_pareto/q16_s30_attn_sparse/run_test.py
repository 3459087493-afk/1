...
CODE = "q16_s30_attn_sparse"
FP_SCALE = 1024; IN_R, OUT_R, CTL = 0x10, 0x1C, 0x00
LUT, DSP, FF, BRAM = "TBD", "TBD", "TBD", "TBD"

print("="*60)
print("Q16 S30 PYNQ-Z2 FULL TEST (3444 samples)")
print("d=16 ff=32 ACTIVE_DIM=11 sparsity=31.25%")
print("="*60)
...
# Save
rows = [
    ('model_id','Ours-Q16-S30-AttnSparse'),('code_name',CODE),
    ('d_model',16),('ff_dim',32),('quant_bits',16),
    ('active_dim',11),('effective_sparsity','31.25%'),
    ...
    ('notes','Q16 S30. LUT=TBD hw_acc='+str(round(hc/na,4))+' F1='+str(round(f1,4))+' latency='+str(round(t1000.mean(),2))+'us.'),
]
...
print(f"\nSaved. acc={hc/na:.4f} F1={f1:.4f} latency={t1000.mean():.2f}us speedup={speedup_fast:.1f}x")
